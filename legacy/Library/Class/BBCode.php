	...
	static function getInstance()
	{
		if (!isset(self::$instance)) {
			...
			$bbcode->addCode(
				...
				'inline',
				array('listitem', 'block', 'inline', 'link', 'handlung'),
				array()
			);
			$bbcode->addCode(
				'i',
			...
			$bbcode->addCode(
				...
				'callback_replace',
				'do_bbcode_size',
				array('callback_replace_param' => 'default'),
				'inline',
				array('listitem', 'block', 'inline', 'link', 'handlung'),
				array()
			);
			...
			$bbcode->addCode(
				...
				'link',
				array('listitem', 'block', 'inline', 'handlung'),
				array('link')
			);
			$bbcode->addCode(
				'img',
				...
				array(),
				'image',
				array('listitem', 'block', 'inline', 'handlung', 'link'),
				array()
			);
			$bbcode->addCode(
				'list',
			...
			$bbcode->addCode(
				...
				'simple_replace',
				null,
				array('start_tag' => '<div class="action post">', 'end_tag' => '</div>'),
				'handlung',
			...
			$bbcode->addCode(
				...
				'simple_replace',
				null,
				array('start_tag' => '<div class="simoff post">', 'end_tag' => '</div>'),
				'block',
				array('listitem', 'block', 'inline', 'link'),
				array()
			);
			...
			$bbcode->addCode(
				...
				'simple_replace',
				null,
				array('start_tag' => '<div class="sl post">', 'end_tag' => '</div>'),
				'block',
				array('listitem', 'block', 'inline', 'link'),
				array()
			);
			$bbcode->addCode(
				...
				'simple_replace',
				null,
				array('start_tag' => '<blockquote>', 'end_tag' => '</blockquote>'),
				'block',
				array('listitem', 'block', 'inline', 'link'),
				array()
			);
			...
			$bbcode->addCode(
				...
				'simple_replace',
				null,
				array('start_tag' => '<p style="text-align:left;">', 'end_tag' => '</p>'),
				'block',
				array('listitem', 'block', 'inline', 'link'),
				array()
			);
			$bbcode->addCode(
				...
				'simple_replace',
				null,
				array('start_tag' => '<p style="text-align:center;">', 'end_tag' => '</p>'),
				'block',
				array('listitem', 'block', 'inline', 'link'),
				array()
			);
			$bbcode->addCode(
				...
				'simple_replace',
				null,
				array('start_tag' => '<p style="text-align:right;">', 'end_tag' => '</p>'),
				'block',
				array('listitem', 'block', 'inline', 'link'),
				array()
			);

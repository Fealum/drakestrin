<?php /* Smarty version Smarty-3.1.5, created on 2013-05-24 15:04:02
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/post/edit.htm" */ ?>
<?php /*%%SmartyHeaderCode:1573287015126dfd8a90456-80910682%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5f6a857f0069972b6972064a102d3e200dc4c00a' => 
    array (
      0 => '/var/www/l3s658/html/drakestrin/application/view/standard/post/edit.htm',
      1 => 1361493160,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1573287015126dfd8a90456-80910682',
  'function' => 
  array (
    'breadcrumbs' => 
    array (
...
<?php if ($_valid && !is_callable('content_5126dfd8c3e32')) {function content_5126dfd8c3e32($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
...
<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'show')>0&&($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'editpost')==2||($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'editpost')==1&&$_smarty_tpl->tpl_vars['user']->value->id==$_smarty_tpl->tpl_vars['obj']->value->user->id))){?>
<form name="editpost" action="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/post/edit/<?php echo $_smarty_tpl->tpl_vars['obj']->value;?>
" method="post">
<textarea name="message"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->message, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</textarea>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('../_function/breadcrumbs.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '1573287015126dfd8a90456-80910682');
content_519f6542cc161($_smarty_tpl);
...
</html><?php }} ?><?php /* Smarty version Smarty-3.1.5, created on 2013-05-24 15:04:02
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/_function/breadcrumbs.htm" */ ?>
<?php if ($_valid && !is_callable('content_519f6542cc161')) {function content_519f6542cc161($_smarty_tpl) {?><?php if (!function_exists('smarty_template_function_breadcrumbs')) {

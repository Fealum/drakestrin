<?php /* Smarty version Smarty-3.1.5, created on 2013-05-25 01:13:00
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/dictionary/viewall.htm" */ ?>
<?php /*%%SmartyHeaderCode:1702830695126ea6e986116-16844881%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eea3af443aba6fb0693d093308a18a60b7d87b14' => 
    array (
      0 => '/var/www/l3s658/html/drakestrin/application/view/standard/dictionary/viewall.htm',
      1 => 1369357659,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1702830695126ea6e986116-16844881',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.5',
  'unifunc' => 'content_5126ea6eac278',
  'variables' => 
  array (
    'config' => 0,
    'user' => 1,
...
<?php if ($_valid && !is_callable('content_5126ea6eac278')) {function content_5126ea6eac278($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
...
/templates/standard/_css/dictionary.css" />
...
"><?php echo $_smarty_tpl->getSubTemplate ("../_notice/".($_smarty_tpl->tpl_vars['i']->value['notice']).".htm", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
	...
	<p>Angezeigt werden <?php echo count($_smarty_tpl->tpl_vars['obj']->value->data);?>
 W&ouml;rter.</p>
	<p class="columns">
...
?>
		<em class="small"><?php echo $_smarty_tpl->tpl_vars['value']->value->code;?>
.</em> = <?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['value']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
.<br />
<?php } ?>
	</p>
	<h3><?php echo $_smarty_tpl->tpl_vars['language_from']->value->name;?>
&nbsp;&mdash;&nbsp;<?php echo $_smarty_tpl->tpl_vars['language_to']->value->name;?>
<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'createdictionary')>0){?> <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/dictionary/create" class="option create" title="Neues Wort erstellen">Neues Wort erstellen</a><?php }?></h3>
	<ul class="columns">
<?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
...
$_smarty_tpl->tpl_vars['value']->_loop = true;
?>
		<li><strong><a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/dictionary/view/<?php echo $_smarty_tpl->tpl_vars['value']->value;?>
"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['value']->value->word, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</a>,</strong>&nbsp;<em class="small"><?php echo $_smarty_tpl->tpl_vars['value']->value->wordtype->code;?>
.</em>
		<?php if ($_smarty_tpl->tpl_vars['value']->value->dictionarykey___from){?><?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['value']->value->dictionarykey___from; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value){
$_smarty_tpl->tpl_vars['item']->_loop = true;
?><a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/dictionary/view/<?php echo $_smarty_tpl->tpl_vars['item']->value->dictionary__to;?>
"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['item']->value->dictionary__to->word, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</a>,&nbsp;<em class="small"><?php echo $_smarty_tpl->tpl_vars['item']->value->dictionary__to->wordtype->code;?>
.</em> 
		<?php } ?><?php }else{ ?>&mdash;&mdash;<?php }?></li>
<?php }
if (!$_smarty_tpl->tpl_vars['value']->_loop) {
?>
Keine W&ouml;rter gefunden!
<?php } ?>
	</ul>
	<h3><span>Historie</span></h3>
	<p>
10. Juli 2006 - Erste funktionsf&auml;hige Version<br />
Gleicher Tag, Sp&auml;tabends - Darstellung in TMTe eingebaut<br />
11. Juli 2006 - Nun gibt es eine einzelne Seite mit weiteren Informationen f&uuml;r jedes Wort und f&uuml;r Verben eine Konjugationstabelle. <br />
Gleicher Tag, 17 Uhr 11 - Der zwanzigste Eintrag wurde hinzugef&uuml;gt! <br />
Gleicher Tag, 23 Uhr 34 - Der f&uuml;nfzigste Eintrag wurde hinzugef&uuml;gt! <br />
17. Dezember 2006 - M&ouml;glichkeit f&uuml;r den User, selbst ein Wort einzutragen<br />
Gleicher Tag, 14 Uhr 06 - Freischaltm&ouml;glichkeit dieser Worte f&uuml;r den Admin durch die Seite<br />
Gleicher Tag, 19 Uhr 30 - M&ouml;glichkeit f&uuml;r den User, mehrere Worte gleichzeitig einzutragen<br />
Gleicher Tag, 19 Uhr 53 - Der f&uuml;nfundsiebzigste Eintrag wurde hinzugef&uuml;gt! <br />
Gleicher Tag, 23 Uhr 42 - Der hundertste Eintrag wurde hinzugef&uuml;gt! <br />
11. Juni 2007 - Der zweihundertste Eintrag wurde hinzugef&uuml;gt! <br />
12. Juni 2007 - Generelle Um&auml;nderung der Darstellung in W&ouml;rterbuchform <br />
27. August 2011 - General&uuml;berarbeitung
	</p>
	<h3><span>Geplant</span></h3>
	<p>
 - Anzeige nur bestimmter Buchstaben m&ouml;glich
	</p>

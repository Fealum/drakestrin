<?php /* Smarty version Smarty-3.1.5, created on 2013-05-25 07:14:59
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/register/std.htm" */ ?>
<?php /*%%SmartyHeaderCode:295348237512744eed63a53-02707231%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5fb9382e3901d9f5c2921823012900014e248499' => 
    array (
      0 => '/var/www/l3s658/html/drakestrin/application/view/standard/register/std.htm',
      1 => 1361493160,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '295348237512744eed63a53-02707231',
  'function' => 
  array (
    'textinput' => 
    array (
...
<?php if ($_valid && !is_callable('content_512744eeec26f')) {function content_512744eeec26f($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('../_function/textinput.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '295348237512744eed63a53-02707231');
content_51a048d3f22c6($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "../_function/textinput.htm" */?>
	<h3>Erster Schritt</h3>
	<p>Die Registrierung im <?php echo $_smarty_tpl->tpl_vars['config']->value->title;?>
 verl&auml;uft in zwei Schritten: 
		<ol>
			<li>Zuerst wird &uuml;berpr&uuml;ft, ob Deine eMail-Adresse korrekt ist. Ohne korrekte eMail-Adresse w&auml;ren wichtige Funktionen des Forums wie administrative Benachrichtigungen oder Hilfe bei einem vergessenen Passwort nicht m&ouml;glich.</li>
			<li>Anschlie&szlig;end kannst Du Deinen gew&uuml;nschten Nutzernamen und Dein Passwort w&auml;hlen.</li>
		</ol>
		Fangen wir also mit Deiner eMail-Adresse an!
	</p>
	<form name="register" action="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/register/validate" method="post">
		<?php smarty_template_function_textinput($_smarty_tpl,array('formname'=>'register','inputname'=>'email','displayname'=>'eMail','maxlength'=>85,'placeholder'=>"email@domain.de",'autofocus'=>true));?>
...
</html><?php }} ?><?php /* Smarty version Smarty-3.1.5, created on 2013-05-25 07:14:59
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/_function/textinput.htm" */ ?>
<?php if ($_valid && !is_callable('content_51a048d3f22c6')) {function content_51a048d3f22c6($_smarty_tpl) {?><?php if (!function_exists('smarty_template_function_textinput')) {

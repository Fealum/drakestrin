<?php /* Smarty version Smarty-3.1.5, created on 2013-07-05 01:23:20
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/dictionary/deletekey.htm" */ ?>
<?php /*%%SmartyHeaderCode:839957327516d8fbaf32e62-49661329%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6bef30c051ae6d1d02e7b7a0a3ce5417cefa0a17' => 
    array (
      0 => '/var/www/l3s658/html/drakestrin/application/view/standard/dictionary/deletekey.htm',
      1 => 1366133253,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '839957327516d8fbaf32e62-49661329',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.5',
  'unifunc' => 'content_516d8fbb15820',
  'variables' => 
  array (
    'config' => 0,
    'user' => 1,
...
<?php if ($_valid && !is_callable('content_516d8fbb15820')) {function content_516d8fbb15820($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
...
: Verkn&uuml;pfung zwischen &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->dictionary__from->word, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&laquo; und &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->dictionary__to->word, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
/log">anmelden</a>]
	<?php }?>
		...
		<h2>Verkn&uuml;pfung zwischen &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->dictionary__from->word, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&laquo; und &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->dictionary__to->word, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
<h3>Sicher?</h3>
<p>Bist Du Dir sicher, dass Du diese Verkn&uuml;pfung l&ouml;schen m&ouml;chtest?</p>
<form name="deletekey" action="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/dictionary/deletekey/<?php echo $_smarty_tpl->tpl_vars['obj']->value;?>
" method="post">
...
/dictionary/view/<?php echo $_smarty_tpl->tpl_vars['obj']->value->dictionary__from;?>
"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->dictionary__from->word, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</a> &rarr; Verkn&uuml;pfung zwischen &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->dictionary__from->word, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&laquo; und &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->dictionary__to->word, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>

<?php /* Smarty version Smarty-3.1.5, created on 2013-06-10 14:59:40
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/thread/edit.htm" */ ?>
<?php /*%%SmartyHeaderCode:1107102722519eb8ad452ca3-64445450%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a60b7d6903831bddd5f0ef4c2e7a811f8f3bea5c' => 
    array (
      0 => '/var/www/l3s658/html/drakestrin/application/view/standard/thread/edit.htm',
      1 => 1361493162,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1107102722519eb8ad452ca3-64445450',
  'function' => 
  array (
    'textinput' => 
    array (
...
<?php if ($_valid && !is_callable('content_519eb8ad67db5')) {function content_519eb8ad67db5($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
...
: <?php if ($_smarty_tpl->tpl_vars['obj']->value->name){?>Thema &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&laquo; bearbeiten<?php }else{ ?>Zugriff nicht gestattet<?php }?></title>
...
/log">anmelden</a>]
	<?php }?>
		...
		<h2><?php if ($_smarty_tpl->tpl_vars['obj']->value->name){?>Thema &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&laquo; bearbeiten<?php }else{ ?>Zugriff nicht gestattet<?php }?></h2>
		<div id="content">
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('../_function/textinput.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '1107102722519eb8ad452ca3-64445450');
content_51b5cdbc45748($_smarty_tpl);
...
<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'editthread')>0){?>
<form name="editthread" action="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/thread/edit/<?php echo $_smarty_tpl->tpl_vars['obj']->value;?>
" method="post">
<?php smarty_template_function_textinput($_smarty_tpl,array('formname'=>'editthread','inputname'=>'name','displayname'=>'Name','autofocus'=>true,'value'=>$_smarty_tpl->tpl_vars['obj']->value->name));?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('../_function/breadcrumbs.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '1107102722519eb8ad452ca3-64445450');
content_51b5cdbc4e7aa($_smarty_tpl);
...
<?php }?> &rarr; <?php if ($_smarty_tpl->tpl_vars['obj']->value->name){?>Thema &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&laquo; bearbeiten<?php }else{ ?>Zugriff nicht gestattet<?php }?></p>
...
</html><?php }} ?><?php /* Smarty version Smarty-3.1.5, created on 2013-06-10 14:59:40
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/_function/textinput.htm" */ ?>
<?php if ($_valid && !is_callable('content_51b5cdbc45748')) {function content_51b5cdbc45748($_smarty_tpl) {?><?php if (!function_exists('smarty_template_function_textinput')) {
...
<?php }} ?><?php /* Smarty version Smarty-3.1.5, created on 2013-06-10 14:59:40
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/_function/breadcrumbs.htm" */ ?>
<?php if ($_valid && !is_callable('content_51b5cdbc4e7aa')) {function content_51b5cdbc4e7aa($_smarty_tpl) {?><?php if (!function_exists('smarty_template_function_breadcrumbs')) {

<?php /* Smarty version Smarty-3.1.5, created on 2013-05-25 02:12:02
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/thread/create.htm" */ ?>
<?php /*%%SmartyHeaderCode:16478005335126de0931d050-66998703%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '132d6a2262d0a5beb8f0bced05025c6d767f65aa' => 
    array (
      0 => '/var/www/l3s658/html/drakestrin/application/view/standard/thread/create.htm',
      1 => 1361493162,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '16478005335126de0931d050-66998703',
  'function' => 
  array (
    'breadcrumbs' => 
    array (
...
<?php if ($_valid && !is_callable('content_5126de09535a4')) {function content_5126de09535a4($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
...
: <?php if ($_smarty_tpl->tpl_vars['obj']->value->name){?>Neues Thema im Forum &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&laquo; erstellen<?php }else{ ?>Zugriff nicht gestattet<?php }?></title>
...
/log">anmelden</a>]
	<?php }?>
		...
		<h2><?php if ($_smarty_tpl->tpl_vars['obj']->value->name){?>Neues Thema im Forum &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&laquo; erstellen<?php }else{ ?>Zugriff nicht gestattet<?php }?></h2>
		<div id="content">
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('../_function/textinput.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '16478005335126de0931d050-66998703');
content_51a001d26bb43($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "../_function/textinput.htm" */?>
<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'show')>0){?>
<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'createthread')>0){?>
<form name="createthread" action="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/thread/create/<?php echo $_smarty_tpl->tpl_vars['obj']->value;?>
" method="post">
<?php smarty_template_function_textinput($_smarty_tpl,array('formname'=>'createthread','inputname'=>'name','displayname'=>'Name','autofocus'=>true));?>

<label for="important">Wichtig: </label><input type="checkbox" name="important" id="important" value="1" <?php if ($_smarty_tpl->tpl_vars['thread']->value['important']==1){?>checked="checked"<?php }?> />
<p>Beitrag: 
<input type="hidden" name="smilies" value="1" />
<input type="hidden" name="signature" value="1" />
<textarea name="message"><?php if (isset($_smarty_tpl->tpl_vars['post']->value['message'])){?><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['post']->value['message'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
<?php }?></textarea></p>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('../_function/breadcrumbs.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '16478005335126de0931d050-66998703');
content_51a001d275699($_smarty_tpl);
...
/board">Forum</a><?php if ($_smarty_tpl->tpl_vars['obj']->value->name){?><?php smarty_template_function_breadcrumbs($_smarty_tpl,array('data'=>$_smarty_tpl->tpl_vars['obj']->value,'url'=>'board/view','parent'=>'board'));?>
<?php }?> &rarr; <?php if ($_smarty_tpl->tpl_vars['obj']->value->name){?>Neues Thema im Forum &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&laquo; erstellen<?php }else{ ?>Zugriff nicht gestattet<?php }?></p>
...
</html><?php }} ?><?php /* Smarty version Smarty-3.1.5, created on 2013-05-25 02:12:02
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/_function/textinput.htm" */ ?>
<?php if ($_valid && !is_callable('content_51a001d26bb43')) {function content_51a001d26bb43($_smarty_tpl) {?><?php if (!function_exists('smarty_template_function_textinput')) {
...
<?php }} ?><?php /* Smarty version Smarty-3.1.5, created on 2013-05-25 02:12:02
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/_function/breadcrumbs.htm" */ ?>
<?php if ($_valid && !is_callable('content_51a001d275699')) {function content_51a001d275699($_smarty_tpl) {?><?php if (!function_exists('smarty_template_function_breadcrumbs')) {

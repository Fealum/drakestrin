<?php /* Smarty version Smarty-3.1.5, created on 2013-06-10 12:58:14
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/register/validate.htm" */ ?>
<?php /*%%SmartyHeaderCode:606601746512905ed9fd1f5-51922317%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd425e79dc053a131e0826d0d667f9d6083df82a7' => 
    array (
      0 => '/var/www/l3s658/html/drakestrin/application/view/standard/register/validate.htm',
      1 => 1361493160,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '606601746512905ed9fd1f5-51922317',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.5',
  'unifunc' => 'content_512905edae8b0',
  'variables' => 
  array (
    'config' => 0,
    'user' => 1,
...
<?php if ($_valid && !is_callable('content_512905edae8b0')) {function content_512905edae8b0($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
...
"><?php echo $_smarty_tpl->getSubTemplate ("../_notice/".($_smarty_tpl->tpl_vars['i']->value['notice']).".htm", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
	...
	<p>Wenn sich kein Fehler eingeschlichen hat, wurde Dir soeben eine eMail an die angegebene Adresse <em><?php echo $_smarty_tpl->tpl_vars['registeremail']->value;?>
</em> zugestellt. In dieser ist ein f&uuml;r <?php echo $_smarty_tpl->tpl_vars['config']->value->emailvalidfor/3600;?>
 Stunden g&uuml;ltiger Link enthalten, mit dem Du Deine eMail-Adresse best&auml;tigen kannst.</p>
	<p>Nach der Best&auml;tigung kannst Du mit der Registrierung fortfahren.</p>

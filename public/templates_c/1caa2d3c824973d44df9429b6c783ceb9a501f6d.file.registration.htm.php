<?php /* Smarty version Smarty-3.1.5, created on 2013-06-10 12:59:44
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/register/registration.htm" */ ?>
<?php /*%%SmartyHeaderCode:1746982033512906195c7372-68234844%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1caa2d3c824973d44df9429b6c783ceb9a501f6d' => 
    array (
      0 => '/var/www/l3s658/html/drakestrin/application/view/standard/register/registration.htm',
      1 => 1361493160,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1746982033512906195c7372-68234844',
  'function' => 
  array (
    'textinput' => 
    array (
...
<?php if ($_valid && !is_callable('content_5129061972fdc')) {function content_5129061972fdc($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('../_function/textinput.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '1746982033512906195c7372-68234844');
content_51b5b1a0e3445($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "../_function/textinput.htm" */?>
	<h3>Zweiter Schritt</h3>
	<p>Deine eMail-Adresse <em><?php echo $_smarty_tpl->tpl_vars['registeremail']->value;?>
</em> wurde best&auml;tigt! W&auml;hle nun einen Nutzernamen und ein Passwort.</p>
	<form name="register" action="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/register/registration/<?php echo $_smarty_tpl->tpl_vars['registeremail']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['registerkey']->value;?>
" method="post">
		<?php smarty_template_function_textinput($_smarty_tpl,array('formname'=>'register','inputname'=>'name','displayname'=>'Nutzername','value'=>$_smarty_tpl->tpl_vars['registername']->value,'maxlength'=>85,'autofocus'=>true));?>

		<?php smarty_template_function_textinput($_smarty_tpl,array('formname'=>'register','inputname'=>'password','displayname'=>'Passwort','type'=>'password'));?>
		...
		<p><input type="checkbox" name="termsofservice" id="termsofservice" value="1" /><label for="termsofservice"> Ich erkl&auml;re mich mit den <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url/'static'/'terms';?>
">Nutzungsbedingungen</a> einverstanden.</label></p>
		<p><input type="submit" value="Registrierung abschlie&szlig;en" name="submit" /></p>
	</form>
...
</html><?php }} ?><?php /* Smarty version Smarty-3.1.5, created on 2013-06-10 12:59:44
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/_function/textinput.htm" */ ?>
<?php if ($_valid && !is_callable('content_51b5b1a0e3445')) {function content_51b5b1a0e3445($_smarty_tpl) {?><?php if (!function_exists('smarty_template_function_textinput')) {

<?php /* Smarty version Smarty-3.1.5, created on 2013-05-24 14:46:06
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/user/editcontact.htm" */ ?>
<?php /*%%SmartyHeaderCode:1399628842519f610e0c92a5-25632706%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e156c46d955dba70b5249961be421881eee61df8' => 
    array (
      0 => '/var/www/l3s658/html/drakestrin/application/view/standard/user/editcontact.htm',
      1 => 1369399532,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1399628842519f610e0c92a5-25632706',
  'function' => 
  array (
    'textinput' => 
    array (
  ...
  'unifunc' => 'content_519f610e3e64a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_519f610e3e64a')) {function content_519f610e3e64a($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
...
: Kontaktm&ouml;glichkeit bearbeiten</title>
...
/log">anmelden</a>]
	<?php }?>
		...
		<h2>Kontaktm&ouml;glichkeit bearbeiten</h2>
		<div id="content">
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('../_function/textinput.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '1399628842519f610e0c92a5-25632706');
content_519f610e1a3d2($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "../_function/textinput.htm" */?>
<form name="editusercontact" action="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/user/editcontact/<?php echo $_smarty_tpl->tpl_vars['obj']->value;?>
" method="post">
<p><label for="protocol">Protokoll: </label><select name="protocol">
<?php  $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['i']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['protocols']->value->data; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['i']->key => $_smarty_tpl->tpl_vars['i']->value){
$_smarty_tpl->tpl_vars['i']->_loop = true;
?>	<option label="<?php echo $_smarty_tpl->tpl_vars['i']->value->name;?>
" value="<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
"<?php if ($_smarty_tpl->tpl_vars['obj']->value->protocol->id==$_smarty_tpl->tpl_vars['i']->value->id){?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['i']->value->name;?>
</option><?php } ?>
</select></p>
<?php smarty_template_function_textinput($_smarty_tpl,array('formname'=>'editusercontact','inputname'=>'contact','displayname'=>'Kontakt','value'=>$_smarty_tpl->tpl_vars['obj']->value->contact));?>

<p><input type="submit" value="Kontaktm&ouml;glichkeit bearbeiten" name="submit" /></p>
</form>
...
</a> &rarr; Kontaktm&ouml;glichkeit bearbeiten</p>
...
</html><?php }} ?><?php /* Smarty version Smarty-3.1.5, created on 2013-05-24 14:46:06
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/_function/textinput.htm" */ ?>
<?php if ($_valid && !is_callable('content_519f610e1a3d2')) {function content_519f610e1a3d2($_smarty_tpl) {?><?php if (!function_exists('smarty_template_function_textinput')) {

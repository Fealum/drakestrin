<?php /* Smarty version Smarty-3.1.5, created on 2013-07-22 20:30:09
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/dictionary/create.htm" */ ?>
<?php /*%%SmartyHeaderCode:457434336516d8f45aaf732-43030495%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7f1f4fb9023c762a98f6360f2f13d6010bd146b9' => 
    array (
      0 => '/var/www/l3s658/html/drakestrin/application/view/standard/dictionary/create.htm',
      1 => 1374517805,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '457434336516d8f45aaf732-43030495',
  'function' => 
  array (
    'textinput' => 
    array (
...
<?php if ($_valid && !is_callable('content_516d8f45c730d')) {function content_516d8f45c730d($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('../_function/textinput.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '457434336516d8f45aaf732-43030495');
content_51ed7a314d40b($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "../_function/textinput.htm" */?>
<form name="createdictionary" action="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/dictionary/create" method="post">
...
<?php smarty_template_function_textinput($_smarty_tpl,array('formname'=>'createdictionary','inputname'=>'word','displayname'=>'Wort','required'=>false));?>

<h3>Erweiterter Modus: </h3>
<p><label for="language">Von: </label><select name="advanced-language-from">
<?php  $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['i']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['languages']->value->data; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['i']->key => $_smarty_tpl->tpl_vars['i']->value){
$_smarty_tpl->tpl_vars['i']->_loop = true;
...
<label for="language">Nach: </label><select name="advanced-language-to">
<?php  $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['i']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['languages']->value->data; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['i']->key => $_smarty_tpl->tpl_vars['i']->value){
$_smarty_tpl->tpl_vars['i']->_loop = true;
...
/dictionary">Diktionar</a> &rarr; Neues Wort erstellen</p>
...
</html><?php }} ?><?php /* Smarty version Smarty-3.1.5, created on 2013-07-22 20:30:09
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/_function/textinput.htm" */ ?>
<?php if ($_valid && !is_callable('content_51ed7a314d40b')) {function content_51ed7a314d40b($_smarty_tpl) {?><?php if (!function_exists('smarty_template_function_textinput')) {

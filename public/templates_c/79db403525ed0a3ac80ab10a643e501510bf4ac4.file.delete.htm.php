<?php /* Smarty version Smarty-3.1.5, created on 2013-07-04 23:18:22
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/dictionary/delete.htm" */ ?>
<?php /*%%SmartyHeaderCode:2107529881516d943c1327d4-66445711%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '79db403525ed0a3ac80ab10a643e501510bf4ac4' => 
    array (
      0 => '/var/www/l3s658/html/drakestrin/application/view/standard/dictionary/delete.htm',
      1 => 1366135927,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2107529881516d943c1327d4-66445711',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.5',
  'unifunc' => 'content_516d943c2ba34',
  'variables' => 
  array (
    'config' => 0,
    'user' => 1,
...
<?php if ($_valid && !is_callable('content_516d943c2ba34')) {function content_516d943c2ba34($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
...
<h3>Sicher?</h3>
<p>Bist Du Dir sicher, dass Du dieses Wort l&ouml;schen m&ouml;chtest?</p>
<p>Bei einer L&ouml;schung werden folgende Verkn&uuml;pfungen ebenfalls gel&ouml;scht:</p>
<ul>
<?php if ($_smarty_tpl->tpl_vars['obj']->value->dictionarykey___from){?>	<li>Von &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->word, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&laquo; zu &hellip;
		<ul>
<?php  $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['i']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['obj']->value->dictionarykey___from; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['i']->key => $_smarty_tpl->tpl_vars['i']->value){
$_smarty_tpl->tpl_vars['i']->_loop = true;
?>			<li><a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/dictionary/view/<?php echo $_smarty_tpl->tpl_vars['i']->value->dictionary__to;?>
"><?php echo $_smarty_tpl->tpl_vars['i']->value->dictionary__to->word;?>
</a></li><?php } ?>
		</ul>
	</li><?php }?>
<?php if ($_smarty_tpl->tpl_vars['obj']->value->dictionarykey___to){?>	<li>Zu &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->word, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&laquo; von &hellip;
		<ul>
<?php  $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['i']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['obj']->value->dictionarykey___to; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['i']->key => $_smarty_tpl->tpl_vars['i']->value){
$_smarty_tpl->tpl_vars['i']->_loop = true;
?>			<li><a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/dictionary/view/<?php echo $_smarty_tpl->tpl_vars['i']->value->dictionary__from;?>
"><?php echo $_smarty_tpl->tpl_vars['i']->value->dictionary__from->word;?>
</a></li><?php } ?>
		</ul>
	</li><?php }?>
</ul>
<form name="deletedictionary" action="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/dictionary/delete/<?php echo $_smarty_tpl->tpl_vars['obj']->value;?>
" method="post">
<input type="hidden" name="delete" value="1" />
<p><input type="submit" value="Wort l&ouml;schen" name="submit" /></p>
</form>
...
&rarr; <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/dictionary">Diktionar</a> &rarr; Wort &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->word, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&laquo; l&ouml;schen</p>

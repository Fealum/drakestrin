<?php /* Smarty version Smarty-3.1.5, created on 2013-05-24 15:00:17
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/dictionary/view.htm" */ ?>
<?php /*%%SmartyHeaderCode:1156066324516c5bd3660be1-49724968%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9119a65ac9953e1b2b2bf9867a17c3d8c7e84a61' => 
    array (
      0 => '/var/www/l3s658/html/drakestrin/application/view/standard/dictionary/view.htm',
      1 => 1366135863,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1156066324516c5bd3660be1-49724968',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.5',
  'unifunc' => 'content_516c5bd37a523',
  'variables' => 
  array (
    'config' => 0,
    'user' => 1,
...
<?php if ($_valid && !is_callable('content_516c5bd37a523')) {function content_516c5bd37a523($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
...
<p><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->wordtype->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
.<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'editdictionary')>0){?> <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/dictionary/edit/<?php echo $_smarty_tpl->tpl_vars['obj']->value;?>
" class="option edit" title="Wort bearbeiten">Wort bearbeiten</a><?php }?><?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'deletedictionary')>0){?> <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/dictionary/delete/<?php echo $_smarty_tpl->tpl_vars['obj']->value;?>
" class="option delete" title="Wort l&ouml;schen">Wort l&ouml;schen</a><?php }?></p> 
<?php if ($_smarty_tpl->tpl_vars['obj']->value->wordtype->code=='sw'){?>
<h3>Derivation</h3>
<p>Substantivierung: tay:<?php echo $_smarty_tpl->tpl_vars['obj']->value->word;?>
, tay:<?php echo $_smarty_tpl->tpl_vars['obj']->value->word;?>
&middot;<?php if (in_array($_smarty_tpl->tpl_vars['obj']->value->word[strlen($_smarty_tpl->tpl_vars['obj']->value->word)-1],array('a','e','o','u'))){?>d<?php }?>ae</p>
<p>Adjektivierung: <?php echo $_smarty_tpl->tpl_vars['obj']->value->word;?>
&middot;is</p>
<p>Verbisierung: la <?php echo $_smarty_tpl->tpl_vars['obj']->value->word;?>
&middot;la</p>
<?php }?>
<?php if ($_smarty_tpl->tpl_vars['obj']->value->dictionarykey___from||$_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'createdictionary')>0){?>
<h3>&Uuml;bersetzungen</h3>
<ol>
<?php if ($_smarty_tpl->tpl_vars['obj']->value->dictionarykey___from){?><?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
...
</a>, <em><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['item']->value->dictionary__to->wordtype->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</em>.<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'deletedictionary')>0){?> <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/dictionary/deletekey/<?php echo $_smarty_tpl->tpl_vars['item']->value;?>
" class="option delete" title="Verkn&uuml;pfung l&ouml;schen">Verkn&uuml;pfung l&ouml;schen</a><?php }?></li><?php } ?><?php }?>
<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'createdictionary')>0){?>	<li><a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/dictionary/createkey/<?php echo $_smarty_tpl->tpl_vars['obj']->value;?>
" class="option create" title="Neue Verkn&uuml;pfung erstellen">Neue Verkn&uuml;pfung erstellen</a></li><?php }?>
</ol> 
<?php }?>

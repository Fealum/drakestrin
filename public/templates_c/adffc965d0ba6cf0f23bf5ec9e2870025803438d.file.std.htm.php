<?php /* Smarty version Smarty-3.1.5, created on 2013-05-25 01:33:27
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/log/std.htm" */ ?>
<?php /*%%SmartyHeaderCode:1853415915126d854435284-64255238%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'adffc965d0ba6cf0f23bf5ec9e2870025803438d' => 
    array (
      0 => '/var/www/l3s658/html/drakestrin/application/view/standard/log/std.htm',
      1 => 1361493159,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1853415915126d854435284-64255238',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.5',
  'unifunc' => 'content_5126d85453a36',
  'variables' => 
  array (
    'config' => 0,
    'user' => 1,
...
<?php if ($_valid && !is_callable('content_5126d85453a36')) {function content_5126d85453a36($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
...
/log/in" method="post">
		<p><label for="email">eMail: </label><input type="email" name="email" maxlength=85<?php if (isset($_smarty_tpl->tpl_vars['logemail']->value)){?> value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['logemail']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
"<?php }?> placeholder="email@domain.de" autofocus required> <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/register">Registrieren</a></p>
		<p><label for="password">Passwort: </label><input type="password" name="password" maxlength=85 required> <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/log/forgotpw">Passwort vergessen?</a></p>

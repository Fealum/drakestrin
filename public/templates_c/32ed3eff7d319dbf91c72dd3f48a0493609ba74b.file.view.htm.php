<?php /* Smarty version Smarty-3.1.5, created on 2013-05-29 03:45:53
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/post/view.htm" */ ?>
<?php /*%%SmartyHeaderCode:81842030351a55dd19d3df4-70331615%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '32ed3eff7d319dbf91c72dd3f48a0493609ba74b' => 
    array (
      0 => '/var/www/l3s658/html/drakestrin/application/view/standard/post/view.htm',
      1 => 1361493160,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '81842030351a55dd19d3df4-70331615',
  'function' => 
  array (
    'breadcrumbs' => 
    array (
  ...
  'unifunc' => 'content_51a55dd1e43ed',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51a55dd1e43ed')) {function content_51a55dd1e43ed($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_utf8ify')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.utf8ify.php';
...
: <?php if (_permissions::getPermission($_smarty_tpl->tpl_vars['obj']->value,'show')>0){?>Beitrag im Thema &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->thread->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
/log">anmelden</a>]
	<?php }?>
		...
		<h2><?php if (_permissions::getPermission($_smarty_tpl->tpl_vars['obj']->value,'show')>0){?>Beitrag im Thema &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->thread->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
<?php if (_permissions::getPermission($_smarty_tpl->tpl_vars['obj']->value,'show')>0&&(_permissions::getPermission($_smarty_tpl->tpl_vars['obj']->value,'editpost')==2||(_permissions::getPermission($_smarty_tpl->tpl_vars['obj']->value,'editpost')==1&&$_smarty_tpl->tpl_vars['user']->value->id==$_smarty_tpl->tpl_vars['obj']->value->user->id))){?>
<form name="editpost" action="post.php" method="post">
<input type="hidden" name="mode" value="edit" />
<input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['obj']->value;?>
" />
<textarea name="message"><?php echo smarty_modifier_utf8ify(mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->message, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8'));?>
</textarea>
...
<?php if (!function_exists('smarty_template_function_breadcrumbs')) {
...
<?php if ($_smarty_tpl->tpl_vars['data']->value->board!='0'){?><?php smarty_template_function_breadcrumbs($_smarty_tpl,array('data'=>$_smarty_tpl->tpl_vars['data']->value->board));?>
<?php }?> &raquo; <?php if ($_smarty_tpl->tpl_vars['data']->value->name){?><a href="board.php?id=<?php echo $_smarty_tpl->tpl_vars['data']->value;?>
"><?php echo htmlentities($_smarty_tpl->tpl_vars['data']->value->name);?>
<?php }else{ ?>&hellip;<?php }?></a><?php $_smarty_tpl->tpl_vars = $saved_tpl_vars;}}?>

 &raquo; <a href="board.php">Forum</a><?php if ($_smarty_tpl->tpl_vars['obj']->value->name){?><?php smarty_template_function_breadcrumbs($_smarty_tpl,array('data'=>$_smarty_tpl->tpl_vars['obj']->value->thread->board));?>
 &raquo; <a href="board.php?id=<?php echo $_smarty_tpl->tpl_vars['obj']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['obj']->value->name;?>
</a><?php }?> &rarr; <?php if (_permissions::getPermission($_smarty_tpl->tpl_vars['obj']->value,'show')>0){?>Beitrag im Thema &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->thread->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>

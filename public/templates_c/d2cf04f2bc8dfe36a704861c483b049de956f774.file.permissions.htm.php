<?php /* Smarty version Smarty-3.1.5, created on 2013-05-24 19:18:34
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/board/permissions.htm" */ ?>
<?php /*%%SmartyHeaderCode:179207701651289d175c2bb0-06262127%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd2cf04f2bc8dfe36a704861c483b049de956f774' => 
    array (
      0 => '/var/www/l3s658/html/drakestrin/application/view/standard/board/permissions.htm',
      1 => 1361493157,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '179207701651289d175c2bb0-06262127',
  'function' => 
  array (
    'breadcrumbs' => 
    array (
...
<?php if ($_valid && !is_callable('content_51289d177a514')) {function content_51289d177a514($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
...
: <?php if ($_smarty_tpl->tpl_vars['obj']->value->name){?>Rechte des Forums &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&laquo;<?php }else{ ?>Zugriff nicht gestattet<?php }?></title>
...
/log">anmelden</a>]
	<?php }?>
		...
		<h2><?php if ($_smarty_tpl->tpl_vars['obj']->value->name){?>Rechte des Forums &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&laquo;<?php }else{ ?>Zugriff nicht gestattet<?php }?></h2>
		<div id="content">
...
<?php if ($_smarty_tpl->tpl_vars['obj']->value->name){?>
<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'createpermission')>0){?><a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/permission/create/board/<?php echo $_smarty_tpl->tpl_vars['obj']->value;?>
" class="option create" title="neues Recht anlegen">Neues Recht anlegen</a><?php }?>
<p>Du kannst das Forum <?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'show')==0){?>nicht <?php }?>sehen.</p>
<p>Du kannst <?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'createboard')==0){?>keine <?php }?>Unterforen erstellen.</p>
<p>Du kannst <?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'editboard')==0){?>keine <?php }?>Unterforen bearbeiten.</p>
<p>Du kannst <?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'deleteboard')==0){?>keine <?php }?>Unterforen l&ouml;schen.</p>

<p>Du kannst <?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'createthread')==0){?>keine <?php }?>Themen erstellen.</p>
<p>Du kannst <?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'editthread')==0){?>keine <?php }?>Themen bearbeiten.</p>
<p>Du kannst <?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'deletethread')==0){?>keine <?php }?>Themen l&ouml;schen.</p>

<p>Du kannst <?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'createpost')==0){?>keine <?php }?>Beitr&auml;ge erstellen.</p>
<p>Du kannst <?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'editpost')==0){?>keine <?php }?>Beitr&auml;ge bearbeiten.</p>
<p>Du kannst <?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'deletepost')==0){?>keine <?php }?>Beitr&auml;ge l&ouml;schen.</p>

<?php if ($_smarty_tpl->tpl_vars['obj']->value->permission___subject){?>
<h3>Spezifische Rechte</h3>
<?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['obj']->value->permission___subject; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['value']->key => $_smarty_tpl->tpl_vars['value']->value){
$_smarty_tpl->tpl_vars['value']->_loop = true;
?>
<p><?php echo $_smarty_tpl->tpl_vars['value']->value->recipient->name;?>
: <?php echo $_smarty_tpl->tpl_vars['value']->value->permit->name;?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('../_function/breadcrumbs.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '179207701651289d175c2bb0-06262127');
content_519fa0ea86451($_smarty_tpl);
...
/board">Forum</a><?php if ($_smarty_tpl->tpl_vars['obj']->value->name&&$_smarty_tpl->tpl_vars['obj']->value->board!='0'){?><?php smarty_template_function_breadcrumbs($_smarty_tpl,array('data'=>$_smarty_tpl->tpl_vars['obj']->value,'url'=>'board/view','parent'=>'board'));?>
<?php }?> &rarr; <?php if ($_smarty_tpl->tpl_vars['obj']->value->name){?>Rechte des Forums &raquo;<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->name, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&laquo;<?php }else{ ?>Zugriff nicht gestattet<?php }?></p>
...
</html><?php }} ?><?php /* Smarty version Smarty-3.1.5, created on 2013-05-24 19:18:34
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/_function/breadcrumbs.htm" */ ?>
<?php if ($_valid && !is_callable('content_519fa0ea86451')) {function content_519fa0ea86451($_smarty_tpl) {?><?php if (!function_exists('smarty_template_function_breadcrumbs')) {

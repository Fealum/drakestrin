<?php /* Smarty version Smarty-3.1.5, created on 2013-07-04 23:11:00
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/dictionary/createkey.htm" */ ?>
<?php /*%%SmartyHeaderCode:1001031785516d8f621775a6-26265918%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '302eaa9fda75b9a22d42f2e22121f1cfedf97b82' => 
    array (
      0 => '/var/www/l3s658/html/drakestrin/application/view/standard/dictionary/createkey.htm',
      1 => 1366466718,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1001031785516d8f621775a6-26265918',
  'function' => 
  array (
    'textinput' => 
    array (
...
<?php if ($_valid && !is_callable('content_516d8f62317ca')) {function content_516d8f62317ca($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
...
: Neue Verkn&uuml;pfung erstellen</title>
...
<link rel="stylesheet" type="text/css" href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/templates/standard/_js/tokeninput/styles/token-input.css" />
...
<script type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/templates/standard/_js/tokeninput/src/jquery.tokeninput.js"></script>
<script type="text/javascript">
$(document).ready(function () {
	$("#word").tokenInput("<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/dictionary/ajax__getwords/", {
		method: "post",
		...
		resultsFormatter: function(item) { return '<li><img src="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/img/language.id/' + item.language + '.png" /> ' + item.word + ', <i>' + item.wordtype + '.</i></li>' },
		tokenFormatter: function(item) { return '<li><img src="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/img/language.id/' + item.language + '.png" /> ' + item.word + ', <i>' + item.wordtype + '.</i></li>' }
    });
});
</script>
...
/log">anmelden</a>]
	<?php }?>
		...
		<h2>Neue Verkn&uuml;pfung erstellen</h2>
		<div id="content">
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('../_function/textinput.htm', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '1001031785516d8f621775a6-26265918');
content_51d5e4e4a49ed($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "../_function/textinput.htm" */?>
<form name="createdictionarykey" action="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
/dictionary/createkey/<?php echo $_smarty_tpl->tpl_vars['obj']->value;?>
" method="post">
<?php smarty_template_function_textinput($_smarty_tpl,array('formname'=>'createdictionarykey','inputname'=>'word','displayname'=>'Zu verkn&uuml;pfende Wort-ID','autofocus'=>true));?>
...
"><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['obj']->value->word, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</a> &rarr; Neue Verkn&uuml;pfung erstellen</p>
...
</html><?php }} ?><?php /* Smarty version Smarty-3.1.5, created on 2013-07-04 23:11:00
         compiled from "/var/www/l3s658/html/drakestrin/application/view/standard/_function/textinput.htm" */ ?>
<?php if ($_valid && !is_callable('content_51d5e4e4a49ed')) {function content_51d5e4e4a49ed($_smarty_tpl) {?><?php if (!function_exists('smarty_template_function_textinput')) {

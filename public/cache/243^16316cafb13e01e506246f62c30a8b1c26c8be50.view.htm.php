...
<?php if ($_valid && !is_callable('content_52f3ab2e43400')) {function content_52f3ab2e43400($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Gordon Shumway</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/243.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 15.03.2010, 08:37</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							...
							<li><em>Herkunft:</em> Freistaat Fuchsen</li>
									<li><em>Amt oder Beruf:</em> Pantoffelfabrikant</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Gordon Shumway</p>

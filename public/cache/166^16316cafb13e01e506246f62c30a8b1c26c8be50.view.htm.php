...
<?php if ($_valid && !is_callable('content_52f084938c982')) {function content_52f084938c982($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Ein kleines Häschen</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/166.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 07.01.2007, 12:59</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
									<li><em>Herkunft:</em> Soma</li>
									<li><em>Amt oder Beruf:</em> Erz&auml;hler-ID f&uuml;r Soma</li>
				</ol>
	</li>
</ol>
...
<h3>Betriebe</h3>
<ol>
	<li>Hasen - und Kaninchenzucht eV: Zucht und Pflege von Kaninchen und Hasen</li>
</ol>

		</div>
		<div id="sidebar">
			<p><a href="http://drakestrin.de/">Kaiserreich Drachenstein</a>
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Ein kleines Häschen</p>

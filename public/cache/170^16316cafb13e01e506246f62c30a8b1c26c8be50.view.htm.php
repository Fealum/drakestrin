...
<?php if ($_valid && !is_callable('content_52f3c371c2c8c')) {function content_52f3c371c2c8c($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Veumir I. Trent</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/170.jpg" /><p id="usertext">Ich bin Veumir und der Kronprinz von Drachenstein! </p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 19.02.2007, 15:50</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 2004</li>
							<li><em>Herkunft:</em> Pretannica / Drachenstein</li>
									<li><em>Amt oder Beruf:</em> Kronprinz</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Veumir I. Trent</p>

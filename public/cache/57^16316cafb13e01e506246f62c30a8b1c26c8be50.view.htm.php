...
<?php if ($_valid && !is_callable('content_52f2e728e6e16')) {function content_52f2e728e6e16($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Lord Georg von Falkenstein</title>
...
/log">anmelden</a>]
	<?php }?>
		...
		<h2>Lord Georg von Falkenstein</h2>
		<div id="content">
...
<ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 22.11.2003, 12:05</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Lord Georg von Falkenstein</p>

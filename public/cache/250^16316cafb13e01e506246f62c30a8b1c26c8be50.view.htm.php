...
<?php if ($_valid && !is_callable('content_52ed5ff435404')) {function content_52ed5ff435404($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Samuél de las Tierras Altas</title>
...
/log">anmelden</a>]
	<?php }?>
		...
		<h2>Samuél de las Tierras Altas</h2>
		<div id="content">
...
<img src="http://drakestrin.de/img/user_avatar.id/250.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 16.08.2010, 13:45</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 434</li>
									<li><em>Interessen:</em> Lautenspiel, Dichtung, Philosophie</li>
						</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Samuél de las Tierras Altas</p>

...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52f385ede9ebd',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52f385ede9ebd')) {function content_52f385ede9ebd($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
     "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="de">
<head>
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<title>Kaiserreich Drachenstein: Edikt zur Wesensbestimmung</title>
...
/log">anmelden</a>]
	<?php }?>
		...
		<h2>Edikt zur Wesensbestimmung</h2>
		<div id="content">
...
<h3>Edikt zur Wesensbestimmung<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'createencyclopedia')>0){?> <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
...
<p>&lt;B&gt;Edikt zur Wesensbestimmung&lt;/B&gt;<br />
&lt;p&gt;<br />
...
&lt;br&gt;Als Art im Sinne des drakischen Rechts gilt eine Population intelligenter Lebewesen, welche vom Staatlichen Institut f&uuml;r Wesensbestimmung als solche ausgezeichnet wurden. Auf sie treffen die im drakischen Recht verankerten Rechte und Pflichten zu. <br />
&lt;p&gt;<br />
&lt;I&gt;Artikel 2 [Sinn des Ediktes]&lt;/I&gt;<br />
&lt;br&gt;Der Sinn des Ediktes besteht in der Schaffung einer Grundlage f&uuml;r die Unterteilung der Arten in unterschiedliche Intelligenzstufen, f&uuml;r die Feststellung eines Reifegrads, der als Vollj&auml;hrigkeit angesehen werden kann, f&uuml;r die Feststellung der nat&uuml;rlichen K&ouml;rperreaktionen auf gewisse Stoffe und f&uuml;r die Erfassung s&auml;mtlicher im Kaiserreich ans&auml;ssigen Arten zum Wohle dessen. <br />
&lt;p&gt;<br />
&lt;I&gt;II. Staatliches Institut zur Wesensbestimmung&lt;/I&gt;<br />
&lt;p&gt;<br />
&lt;I&gt;Artikel 3 [Aufgaben und Leitung]&lt;/I&gt;<br />
&lt;br&gt;&lt;sup&gt<img src="http://drakestrin.de/img/emoticon/38.gif" title="Weinen">1)&lt;/sup&gt; Zust&auml;ndig f&uuml;r <br />
&lt;br&gt; &ndash;&nbsp;die Erfassung s&auml;mtlicher im Kaiserreich ans&auml;ssigen Arten, <br />
&lt;br&gt; &ndash;&nbsp;die Festlegung der Richtlinien zur Zuordnung von Wesen zu Arten, <br />
&lt;br&gt; &ndash;&nbsp;die Unterteilung der Arten in unterschiedliche Intelligenzstufen, <br />
&lt;br&gt; &ndash;&nbsp;die Feststellung eines Reifegrads, der als Vollj&auml;hrigkeit angesehen werden kann und<br />
&lt;br&gt; &ndash;&nbsp;die Feststellung der nat&uuml;rlichen K&ouml;rperreaktionen auf gewisse Stoffe <br />
&lt;br&gt;ist das Staatliche Institut f&uuml;r Wesensbestimmung. <br />
&lt;br&gt;&lt;sup&gt<img src="http://drakestrin.de/img/emoticon/38.gif" title="Weinen">2)&lt;/sup&gt; Der Vorgang dieser Aufgaben muss f&uuml;r jede behandelte Art streng nach den in Artikel 4 festgelegten Richtlinien verlaufen. <br />
&lt;br&gt;&lt;sup&gt<img src="http://drakestrin.de/img/emoticon/38.gif" title="Weinen">3)&lt;/sup&gt; Die Leitung des Staatlichen Instituts zur Wesensbestimmung wird vom Kaiser oder einer vom Kaiser dazu bem&auml;chtigten Person ernannt und entlassen. <br />
&lt;p&gt;<br />
&lt;I&gt;Artikel 4 [Vorgang der Aufgaben]&lt;/I&gt;<br />
&lt;br&gt;F&uuml;r die Klassifizierung einer Art werden nachfolgende Vorgehen in angegebener Reihenfolge verwendet. Die k&ouml;rperliche und geistige Sch&auml;digung eines Wesens aufgrund der Klassifizierung ist nicht gestattet. <br />
&lt;br&gt;&lt;sup&gt<img src="http://drakestrin.de/img/emoticon/38.gif" title="Weinen">1)&lt;/sup&gt; F&uuml;nfundzwanzig Exemplare oder bei Nichtverf&uuml;gbarkeit weniger der zu klassifizierenden Art, von welchen je f&uuml;nf Exemplare einer statistisch repr&auml;sentativen, gleichen Altersgruppe angeh&ouml;ren, werden Pr&uuml;fungen <br />
&lt;br&gt; &ndash;&nbsp;zur Intelligenz, <br />
&lt;br&gt; &ndash;&nbsp;zur Vernunft, <br />
&lt;br&gt; &ndash;&nbsp;zur Kreativit&auml;t, <br />
&lt;br&gt; &ndash;&nbsp;zur Entdeckungsgabe, <br />
&lt;br&gt; &ndash;&nbsp;zur Kommunikationsgabe, <br />
&lt;br&gt; &ndash;&nbsp;zur Charakterbildung und <br />
&lt;br&gt; &ndash;&nbsp;zur Instinktunabh&auml;ngigkeit <br />
&lt;br&gt;unterzogen. Die Pr&uuml;fungen werden jeweils mit einer Note zwischen eins und zehn benotet, wobei eins der schlechtesten zu erreichenden Note und zehn der Bestnote entspricht. Entspricht der Durchschnitt aller Noten einem gleichen oder besseren Wert als sechs, gilt die Art als Art im Sinne des drakischen Rechts. <br />
&lt;br&gt;&lt;sup&gt<img src="http://drakestrin.de/img/emoticon/38.gif" title="Weinen">2)&lt;/sup&gt; Sollte eine Art als Art im Sinne des drakischen Rechts angenommen sein, so wird von der j&uuml;ngsten Altersgruppe ausgehend die &auml;lteste Altersgruppe ausgew&auml;hlt, die nicht einen Durchschnittswert gleich oder besser als sechs hat und im Vergleich zur n&auml;chsten Altersgruppe im in Absatz (1) genannten Verfahren wiederum gepr&uuml;ft, bis auf ein Jahrzehnt genau der Zeitpunkt ermittelt ist, bei dem der Wert gleich oder besser als sechs ist. Dieser Zeitpunkt gilt als Reifegrad, der als Vollj&auml;hrigkeit angesehen wird und im drakischen Recht als solcher gilt. <br />
&lt;br&gt;&lt;sup&gt<img src="http://drakestrin.de/img/emoticon/38.gif" title="Weinen">3)&lt;/sup&gt; F&uuml;nfundzwanzig Exemplare oder bei Nichtverf&uuml;gbarkeit weniger der zu klassifizierenden Art, welche allesamt &uuml;ber dem vorher bestimmten Reifegrad, der als Vollj&auml;hrigkeit angesehen wird, liegen, werden auf ihre Reaktion auf kleine Mengen Alkohol und Nikotin gepr&uuml;ft. Die Pr&uuml;fergebnisse bestimmen, ob der zu klassifizierenden Art der Genuss von Alkohol und Nikotin im Sinne des Edikts &uuml;ber den Konsum von Rauschmitteln erlaubt ist. <br />
&lt;p&gt;<br />
&lt;I&gt;Artikel 5 [Ver&ouml;ffentlichung und Widerruf]&lt;/I&gt;<br />
&lt;br&gt;&lt;sup&gt<img src="http://drakestrin.de/img/emoticon/38.gif" title="Weinen">1)&lt;/sup&gt; Zu jeder gepr&uuml;ften Art wird ein Abschlussbericht ver&ouml;ffentlicht, welcher <br />
&lt;br&gt; &ndash;&nbsp;eine Kurzbeschreibung, <br />
&lt;br&gt; &ndash;&nbsp;eine ausf&uuml;hrliche Beschreibung, <br />
&lt;br&gt; &ndash;&nbsp;eine zeichnerische Draufsicht, Profilsicht und Vorderansicht, <br />
&lt;br&gt; &ndash;&nbsp;die Pr&uuml;fungsergebnisse, <br />
&lt;br&gt; &ndash;&nbsp;die Einstufung und<br />
&lt;br&gt; &ndash;&nbsp;ein Zertifikat zur Einstufung<br />
&lt;br&gt;der gepr&uuml;ften Art enth&auml;lt. <br />
&lt;br&gt;&lt;sup&gt<img src="http://drakestrin.de/img/emoticon/38.gif" title="Weinen">2)&lt;/sup&gt; Eine Klassifizierung kann Aufgrund eines Irrtums oder Aufgrund neuer, unbeachteter Aspekte widerrufen werden. In diesem Falle ist eine sofortige Neupr&uuml;fung der betroffenen Art zu veranlassen. <br />
&lt;p&gt;<br />
&lt;I&gt;Artikel 6 [Beschwerde gegen Klassifizierungen]&lt;/I&gt;<br />
&lt;br&gt;Jedes Lebewesen kann gegen die Klassifizierung einer Art durch das staatliche Institut f&uuml;r Wesensbestimmung Beschwerde einlegen. Ist die Beschwerde in einer f&uuml;r das Institut verst&auml;ndlichen Form verfasst und nach gr&uuml;ndlicher Pr&uuml;fung f&uuml;r berechtigt befunden worden, ist die Klassifizierung der entsprechenden Art zur&uuml;ckzuziehen und eine sofortige Neupr&uuml;fung der betroffenen Art zu veranlassen. Wird die Beschwerde zur&uuml;ckgewiesen, ist in einem &ouml;ffentlich zug&auml;nglichen Schreiben der Grund f&uuml;r das Zur&uuml;ckweisen der Beschwerde zu nennen. <br />
&lt;p&gt;<br />
&lt;I&gt;So beschlossen von Kaiser Veuxin II. von Drachenstein am 19. Kaltorles 24024&lt;/I&gt;</p>

		</div>
		<div id="sidebar">
			<p><a href="http://drakestrin.de/">Kaiserreich Drachenstein</a>
&raquo; <a href="http://drakestrin.de/encyclopedia">Kompendium</a> &rarr; <a href="http://drakestrin.de/encyclopedia/view/3">Verwaltung</a> &rarr; <a href="http://drakestrin.de/encyclopedia/view/9">Edikte</a> &rarr; Edikt zur Wesensbestimmung</p>

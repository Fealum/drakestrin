...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52ec5038d0529',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ec5038d0529')) {function content_52ec5038d0529($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
     "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="de">
<head>
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<title>Kaiserreich Drachenstein: Postwesen</title>
...
<h3>Das Drakische Postwesen<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'createencyclopedia')>0){?> <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
...
<p>Das drakische Postwesen besteht haupts&auml;chlich aus der drakischen Post, ein Botennetzwerk, welche daf&uuml;r sorgt, dass ein jeder Briefe verschicken kann, ohne einen Boten zu besitzen. Die Entlohnung erfolgt durch Briefmarken, kleine, meist einfach bedruckte oder beschriebene Zettel, die mit ein oder zwei Tropfen Siegelwachs am Briefverschluss angef&uuml;gt werden. Die Briefmarken werden im Vorraus vom Boten verkauft. Die Versandkosten eines Briefes sind abh&auml;ngig von der Strecke, die der Brief zur&uuml;cklegt. Der Bote bringt die Briefe per Pferd, die daf&uuml;r extra gez&uuml;chteten Pferde sind &auml;usserst schnell und ausdauernd, sollten sie doch einmal erm&uuml;den, k&ouml;nnen sie sich in Poststationen, welche meist in Tavernen an den Poststrecken integriert sind, ausruhen, w&auml;hrend der Bote mit einem erholten Pferd weiterreiten kann. </p>

		</div>
		<div id="sidebar">
			<p><a href="http://drakestrin.de/">Kaiserreich Drachenstein</a>
&raquo; <a href="http://drakestrin.de/encyclopedia">Kompendium</a> &rarr; <a href="http://drakestrin.de/encyclopedia/view/2">Allgemeines</a> &rarr; Postwesen</p>

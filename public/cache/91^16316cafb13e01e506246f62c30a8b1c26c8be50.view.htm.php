...
<?php if ($_valid && !is_callable('content_52f30686e4979')) {function content_52f30686e4979($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Don Rumata LXXI.</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/91.jpg" /><p id="usertext">Duxx Marka de Estoria Primus inter pares Imperator minor Imperium Arkanarum<br />
<br />
</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 27.10.2004, 23:45</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 1971</li>
							<li><em>Herkunft:</em> Marka de Estoria</li>
							<li><em>Interessen:</em> Met</li>
							<li><em>Amt oder Beruf:</em> Duxx Marka de Estoria Primus inter pares Imperator minor Imperium Arkanarum</li>
				</ol>
	</li>
...
" class="option create" title="neue Kontaktm&ouml;glichkeit hinzuf&uuml;gen">neue Kontaktm&ouml;glichkeit hinzuf&uuml;gen</a><?php }?></h4>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Don Rumata LXXI.</p>

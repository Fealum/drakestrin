...
<?php if ($_valid && !is_callable('content_52f32551115cc')) {function content_52f32551115cc($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Lord Bohne</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/103.jpg" /><p id="usertext">Ich bin nett, hilfsbereit und im JRK Eggenstein t&auml;tig.</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 26.11.2004, 18:36</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							...
							<li><em>Interessen:</em> Computer spielen</li>
							<li><em>Amt oder Beruf:</em> Sch&uuml;ler</li>
				</ol>
	</li>
</ol>
...
<h3>Betriebe</h3>
<ol>
	<li>Lord Bohnes Rarit&auml;ten: Test</li>
	<li>Lord Bohnes Steinbruch: Steinbruch aus Pisar, hat nur die besten Steinsorten.</li>
</ol>

		</div>
		<div id="sidebar">
			<p><a href="http://drakestrin.de/">Kaiserreich Drachenstein</a>
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Lord Bohne</p>

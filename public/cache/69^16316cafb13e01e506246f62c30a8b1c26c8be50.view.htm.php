...
<?php if ($_valid && !is_callable('content_52ec33335e6e6')) {function content_52ec33335e6e6($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Valen EntilZha</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/69.jpg" /><p id="usertext">Ich bin nur ein bescheidenener M&ouml;nch des Parn!</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 22.01.2004, 15:58</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							...
							<li><em>Herkunft:</em> W&auml;lder von Pelata</li>
							<li><em>Interessen:</em> lesen, beten, w&auml;lder durchstreifen</li>
							<li><em>Amt oder Beruf:</em> Novize des Pran</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Valen EntilZha</p>

...
<?php if ($_valid && !is_callable('content_52f39af98f6d6')) {function content_52f39af98f6d6($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Cara d'Anjalia</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/193.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 13.11.2007, 22:45</li>
...
<h3>Betriebe</h3>
<ol>
	<li>Schreinerei Iryit: Dies ist die erste und damit traditionsreichste und beste Schreineri in Iryit.</li>
	<li>Minen von Vorthar: Siehe Name.</li>
	<li>Landwirtschaftlicher Betrieb 1: </li>
</ol>

		</div>
		<div id="sidebar">
			<p><a href="http://drakestrin.de/">Kaiserreich Drachenstein</a>
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Cara d'Anjalia</p>

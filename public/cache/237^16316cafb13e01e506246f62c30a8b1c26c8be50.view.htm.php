...
<?php if ($_valid && !is_callable('content_52f3ba986817d')) {function content_52f3ba986817d($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Nortius Erudio Xeledon</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/237.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 23.12.2009, 14:44</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 1990</li>
									<li><em>Interessen:</em> Ju-Jutsu, Musik, Kreatives Schreiben</li>
							<li><em>Amt oder Beruf:</em> Student</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Nortius Erudio Xeledon</p>

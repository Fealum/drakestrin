...
<?php if ($_valid && !is_callable('content_52ed885311107')) {function content_52ed885311107($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Eiren Ziip</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/231.jpg" /><p id="usertext">Wanderer,H&auml;ndler</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 05.07.2009, 00:00</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 1960</li>
							<li><em>Herkunft:</em> Graifenfurt</li>
									<li><em>Amt oder Beruf:</em> H&auml;ndler</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Eiren Ziip</p>

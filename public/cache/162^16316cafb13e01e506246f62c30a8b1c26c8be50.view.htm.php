...
<?php if ($_valid && !is_callable('content_52ec905f82e4b')) {function content_52ec905f82e4b($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Iltera Dralant</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/162.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 17.12.2006, 13:52</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
									<li><em>Herkunft:</em> Arcana, Pisar</li>
...
<ol class="inventory">
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Iltera Dralant</p>

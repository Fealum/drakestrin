...
<?php if ($_valid && !is_callable('content_52ed8b5a6eb01')) {function content_52ed8b5a6eb01($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Faith</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/165.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 01.01.2007, 22:57</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> weiblich</li>
							...
							<li><em>Herkunft:</em> Vincaster</li>
									<li><em>Amt oder Beruf:</em> Buchhalterin</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Faith</p>

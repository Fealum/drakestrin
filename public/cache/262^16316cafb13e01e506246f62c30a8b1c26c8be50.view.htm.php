...
<?php if ($_valid && !is_callable('content_52ecdd0b1043a')) {function content_52ecdd0b1043a($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Raen'Mel Parnias</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/262.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 22.01.2011, 17:18</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> weiblich</li>
									<li><em>Herkunft:</em> aus dem Herzen Anoiz (Malazien)</li>
							<li><em>Interessen:</em> Meditation, &Uuml;bungen im Umgang mit dem Bogen, Mutter Natur ehren und ihr dienen</li>
							<li><em>Amt oder Beruf:</em> Schamanin</li>
				</ol>
	</li>
...
" class="option create" title="neue Kontaktm&ouml;glichkeit hinzuf&uuml;gen">neue Kontaktm&ouml;glichkeit hinzuf&uuml;gen</a><?php }?></h4>
				<ol>
				<li><em>ICQ:</em> <a href="http://www.icq.com/people/468659880/">468659880</a><?php if (($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'edituser')==2||($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'edituser')==1&&$_smarty_tpl->tpl_vars['user']->value->id==$_smarty_tpl->tpl_vars['obj']->value->id))){?> <a href="http://drakestrin.de/user/editcontact/69" class="option edit" title="Kontaktm&ouml;glichkeit bearbeiten">Kontaktm&ouml;glichkeit bearbeiten</a> <a href="http://drakestrin.de/user/deletecontact/69" class="option delete" title="Kontaktm&ouml;glichkeit l&ouml;schen">Kontaktm&ouml;glichkeit l&ouml;schen</a><?php }?></li>
			</ol>
			</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Raen'Mel Parnias</p>

...
<?php if ($_valid && !is_callable('content_52f3c7e35cd84')) {function content_52f3c7e35cd84($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: TiAnO</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/73.jpg" /><p id="usertext">Inoffizieller Zeitreisender aus RPR</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 15.02.2004, 22:21</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 2730</li>
							<li><em>Herkunft:</em> andere Dimension und Zeit</li>
								</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; TiAnO</p>

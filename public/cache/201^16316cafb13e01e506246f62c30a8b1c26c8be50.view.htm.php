...
<?php if ($_valid && !is_callable('content_52ef3fc408fba')) {function content_52ef3fc408fba($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Jette Tiuri</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/201.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 23.03.2008, 17:17</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> weiblich</li>
									<li><em>Herkunft:</em> Helith</li>
							<li><em>Interessen:</em> Feuer</li>
							<li><em>Amt oder Beruf:</em> Gr&auml;fin von Helith</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Jette Tiuri</p>

...
<?php if ($_valid && !is_callable('content_52f29ec3d140b')) {function content_52f29ec3d140b($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Caroline de Montclané</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/80.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 05.04.2004, 21:35</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> weiblich</li>
							<li><em>Geburtstag:</em> 1982</li>
							<li><em>Herkunft:</em> Chenouseaux/Anelka</li>
									<li><em>Amt oder Beruf:</em> Kronprinzessin/Sonderbotschafterin</li>
				</ol>
	</li>
...
" class="option create" title="neue Kontaktm&ouml;glichkeit hinzuf&uuml;gen">neue Kontaktm&ouml;glichkeit hinzuf&uuml;gen</a><?php }?></h4>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Caroline de Montclané</p>

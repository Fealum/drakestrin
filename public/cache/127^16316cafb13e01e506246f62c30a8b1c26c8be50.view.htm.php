...
<?php if ($_valid && !is_callable('content_52eb32ebad4c1')) {function content_52eb32ebad4c1($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Stefan Hellbusch</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/127.jpg" /><p id="usertext">Bundespr&auml;sident Condorias</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 01.09.2005, 22:06</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
							<li><em>Geburtstag:</em> 1990</li>
							<li><em>Herkunft:</em> Condoria</li>
									<li><em>Amt oder Beruf:</em> Bundespr&auml;sident</li>
				</ol>
	</li>
...
" class="option create" title="neue Kontaktm&ouml;glichkeit hinzuf&uuml;gen">neue Kontaktm&ouml;glichkeit hinzuf&uuml;gen</a><?php }?></h4>
				<ol>
				<li><em>ICQ:</em> <a href="http://www.icq.com/people/260559292/">260559292</a><?php if (($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'edituser')==2||($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'edituser')==1&&$_smarty_tpl->tpl_vars['user']->value->id==$_smarty_tpl->tpl_vars['obj']->value->id))){?> <a href="http://drakestrin.de/user/editcontact/34" class="option edit" title="Kontaktm&ouml;glichkeit bearbeiten">Kontaktm&ouml;glichkeit bearbeiten</a> <a href="http://drakestrin.de/user/deletecontact/34" class="option delete" title="Kontaktm&ouml;glichkeit l&ouml;schen">Kontaktm&ouml;glichkeit l&ouml;schen</a><?php }?></li>
				<li><em>Website:</em> <a href="http://www.bundesrepublik-condoria.de.vu">http://www.bundesrepublik-condoria.de.vu</a><?php if (($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'edituser')==2||($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'edituser')==1&&$_smarty_tpl->tpl_vars['user']->value->id==$_smarty_tpl->tpl_vars['obj']->value->id))){?> <a href="http://drakestrin.de/user/editcontact/35" class="option edit" title="Kontaktm&ouml;glichkeit bearbeiten">Kontaktm&ouml;glichkeit bearbeiten</a> <a href="http://drakestrin.de/user/deletecontact/35" class="option delete" title="Kontaktm&ouml;glichkeit l&ouml;schen">Kontaktm&ouml;glichkeit l&ouml;schen</a><?php }?></li>
			</ol>
			</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Stefan Hellbusch</p>

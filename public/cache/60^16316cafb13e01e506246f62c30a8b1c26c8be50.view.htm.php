...
<?php if ($_valid && !is_callable('content_52ed2b64e1db9')) {function content_52ed2b64e1db9($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Schatten in der Dunkelheit</title>
...
/log">anmelden</a>]
	<?php }?>
		...
		<h2>Schatten in der Dunkelheit</h2>
		<div id="content">
...
<img src="http://drakestrin.de/img/user_avatar.id/60.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 20.12.2003, 13:48</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
									<li><em>Herkunft:</em> Kanalisation von Pretannica</li>
									<li><em>Amt oder Beruf:</em> Meisterdieb</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Schatten in der Dunkelheit</p>

...
<?php if ($_valid && !is_callable('content_52f3b34c2d15f')) {function content_52f3b34c2d15f($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Manfred Hilgenbecker</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/464.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 23.02.2013, 19:10</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
									<li><em>Herkunft:</em> Fuchsen</li>
									<li><em>Amt oder Beruf:</em> Hofkanzler a.D.</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Manfred Hilgenbecker</p>

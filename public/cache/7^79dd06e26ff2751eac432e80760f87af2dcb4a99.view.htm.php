...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52f2672ff3e8a',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52f2672ff3e8a')) {function content_52f2672ff3e8a($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
     "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="de">
<head>
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<title>Kaiserreich Drachenstein: Kultur</title>
...
<h3>Die Kultur Drachensteins<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'createencyclopedia')>0){?> <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
...
<p>Gerade die Kultur ist in Drachenstein aufgrund des Fantasy-Mittelalters, welches simuliert wird, &auml;usserst wichtig. Auf den folgenden Seiten m&ouml;chten wir sie Euch ein bisschen n&auml;her bringen. </p>
<h3>Unterseiten</h3>
<ol>
	<li><a href="http://drakestrin.de/encyclopedia/view/8">Sagen &amp; Legenden</a>
	<ol>
	<li><a href="http://drakestrin.de/encyclopedia/view/20">W&iacute;nn&acirc;n Ivorkopf</a>
		</li>
	<li><a href="http://drakestrin.de/encyclopedia/view/21">Tr&auml;nen aus Gold</a>
		</li>
	<li><a href="http://drakestrin.de/encyclopedia/view/22">Orkkrieg</a>
		</li>
</ol>	</li>
</ol>
...
&raquo; <a href="http://drakestrin.de/encyclopedia">Kompendium</a> &rarr; Kultur</p>

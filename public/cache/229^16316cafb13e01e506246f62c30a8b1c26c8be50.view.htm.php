...
<?php if ($_valid && !is_callable('content_52f2ad4fa5b9e')) {function content_52f2ad4fa5b9e($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Caphalor</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/229.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 12.05.2009, 20:21</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
									<li><em>Herkunft:</em> Ds&ocirc;n Faeross</li>
							<li><em>Interessen:</em> Kunst, Geschichte, Politik</li>
							<li><em>Amt oder Beruf:</em> Kaiser der Albae von Ds&ocirc;n Faeross</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Caphalor</p>

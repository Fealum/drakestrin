...
<?php if ($_valid && !is_callable('content_52f3c068aa496')) {function content_52f3c068aa496($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Walter Müller</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/261.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 18.12.2010, 17:52</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
									...
									<li><em>Amt oder Beruf:</em> Hofrath f&uuml;r &Auml;u&szlig;eres</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Walter Müller</p>

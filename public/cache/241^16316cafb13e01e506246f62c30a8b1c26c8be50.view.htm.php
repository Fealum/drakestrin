...
<?php if ($_valid && !is_callable('content_52efa7e4704cd')) {function content_52efa7e4704cd($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Medin</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/241.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 17.02.2010, 22:54</li>
...
<h3>Betriebe</h3>
<ol>
	<li>Medins F&auml;rberei: Ein kleines F&auml;rberh&auml;usschen unweit des Marktplatzes am Fluss gelegen. Vor der T&uuml;r h&auml;ngen gro&szlig;e, bunte Stoffbahnen zum Trocknen in der Sonne.</li>
</ol>

		</div>
		<div id="sidebar">
			<p><a href="http://drakestrin.de/">Kaiserreich Drachenstein</a>
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Medin</p>

...
<?php if ($_valid && !is_callable('content_52ed5f840ed00')) {function content_52ed5f840ed00($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Nyrociel</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/266.jpg" /><p id="usertext">Neben-ID</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 14.02.2011, 19:01</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> weiblich</li>
							<li><em>Geburtstag:</em> 1862</li>
							<li><em>Herkunft:</em> Pretanz</li>
							<li><em>Interessen:</em> Reiten, Gedichte lesen und schreiben, Degenfechten</li>
							<li><em>Amt oder Beruf:</em> Lady</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Nyrociel</p>

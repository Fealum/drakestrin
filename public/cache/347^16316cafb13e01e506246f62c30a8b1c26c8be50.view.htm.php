...
<?php if ($_valid && !is_callable('content_52f4120bb426e')) {function content_52f4120bb426e($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Kyra</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/347.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 13.05.2012, 21:20</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
									<li><em>Herkunft:</em> Gebirge von Pisar</li>
								</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Kyra</p>

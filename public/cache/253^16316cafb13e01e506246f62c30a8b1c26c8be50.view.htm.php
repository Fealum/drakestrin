...
<?php if ($_valid && !is_callable('content_52f47f7d58299')) {function content_52f47f7d58299($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Attilio da Vargazza</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/253.jpg" /><p id="usertext">Im Auftrag der Republik.</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 01.09.2010, 11:38</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
									<li><em>Herkunft:</em> Palatina sul Aqua</li>
							<li><em>Interessen:</em> Die Heimat vertreten</li>
							<li><em>Amt oder Beruf:</em> Botschafter Palatinas</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Attilio da Vargazza</p>

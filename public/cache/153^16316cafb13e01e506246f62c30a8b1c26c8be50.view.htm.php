...
<?php if ($_valid && !is_callable('content_52ed5e8b667a8')) {function content_52ed5e8b667a8($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Valmir</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/153.jpg" /><p id="usertext">Verstorben aufgrund einer schamlosen Intrige. </p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 19.08.2006, 18:13</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
									<li><em>Herkunft:</em> Am Hofe des Kaisers</li>
									<li><em>Amt oder Beruf:</em> Hofk&auml;mmerer </li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Valmir</p>

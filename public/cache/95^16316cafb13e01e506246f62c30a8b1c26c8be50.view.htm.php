...
<?php if ($_valid && !is_callable('content_52ed6f3d3c8e8')) {function content_52ed6f3d3c8e8($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Nicky da Pampa</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/95.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 14.11.2004, 16:46</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Nicky da Pampa</p>

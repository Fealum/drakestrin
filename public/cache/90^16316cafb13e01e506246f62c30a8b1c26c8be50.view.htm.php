...
<?php if ($_valid && !is_callable('content_52ef2a528499a')) {function content_52ef2a528499a($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Lord Sinclair</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/90.jpg" /><p id="usertext">Reichsverwalter von Drachenstein</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 27.10.2004, 16:38</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 1409</li>
							<li><em>Herkunft:</em> Malazien</li>
									<li><em>Amt oder Beruf:</em> Lord</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Lord Sinclair</p>

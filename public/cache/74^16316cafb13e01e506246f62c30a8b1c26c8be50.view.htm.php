...
<?php if ($_valid && !is_callable('content_52ef0860b744b')) {function content_52ef0860b744b($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: saibot eznelk von Vitora</title>
...
/log">anmelden</a>]
	<?php }?>
		...
		<h2>saibot eznelk von Vitora</h2>
		<div id="content">
...
<ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 19.02.2004, 16:03</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; saibot eznelk von Vitora</p>

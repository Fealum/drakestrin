...
<?php if ($_valid && !is_callable('content_52f30dcc97c3c')) {function content_52f30dcc97c3c($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Bardo Brandswieg</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/258.jpg" /><p id="usertext">Graf von Melar</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 13.10.2010, 15:55</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
									<li><em>Herkunft:</em> Rosener/Melar</li>
									<li><em>Amt oder Beruf:</em> Graf von Melar</li>
				</ol>
	</li>
</ol>
...
<h3>Besitz</h3>
<ol class="inventory">
	<li><img src="http://drakestrin.de/img/item.img/147.png" /> Baguette: 1, 0</li>
</ol>
<h3>Betriebe</h3>
<ol>
	<li>Gut Brandswieg: Gutshof </li>
	<li>Manfaktur Brandswieg: </li>
	<li>Brandswiegs: </li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Bardo Brandswieg</p>

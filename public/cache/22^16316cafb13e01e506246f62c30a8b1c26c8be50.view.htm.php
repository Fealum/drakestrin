...
<?php if ($_valid && !is_callable('content_52f33c3a98f46')) {function content_52f33c3a98f46($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Freyja Asgerdottir</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/22.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 17.07.2003, 18:16</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> weiblich</li>
									<li><em>Herkunft:</em> Svaerrike/Vinland</li>
								</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Freyja Asgerdottir</p>

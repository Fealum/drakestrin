...
<?php if ($_valid && !is_callable('content_52f225e9da93e')) {function content_52f225e9da93e($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Nera Kohpardor</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/468.jpg" /><p id="usertext">M&ouml;ge Parn meine Wege leiten, Nerron meinen Durst l&ouml;schen, Marron mein Schwert f&uuml;hren und Zerron meine Seele bewahren.</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 20.04.2013, 02:08</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
							...
							<li><em>Interessen:</em> Religion, Mode und alle anderen sch&ouml;nen Dinge</li>
							<li><em>Amt oder Beruf:</em> Erbin</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Nera Kohpardor</p>

...
<?php if ($_valid && !is_callable('content_52ec662debc0f')) {function content_52ec662debc0f($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Hogarth Carson McSniff</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/267.jpg" /><p id="usertext">Generaldirektor von Victorien</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 09.03.2011, 15:17</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							...
							<li><em>Herkunft:</em> Victorien</li>
								</ol>
	</li>
...
" class="option create" title="neue Kontaktm&ouml;glichkeit hinzuf&uuml;gen">neue Kontaktm&ouml;glichkeit hinzuf&uuml;gen</a><?php }?></h4>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Hogarth Carson McSniff</p>

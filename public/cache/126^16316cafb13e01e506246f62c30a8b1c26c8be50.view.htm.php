...
<?php if ($_valid && !is_callable('content_52f0604b881ad')) {function content_52f0604b881ad($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Kristofer da Ripat</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/126.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 22.08.2005, 17:11</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 1968</li>
							<li><em>Herkunft:</em> Burg Ripat, MdE</li>
							<li><em>Interessen:</em> Sport, Mythologie, Politik</li>
							<li><em>Amt oder Beruf:</em> &Uuml;bergangsreichskanzler</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Kristofer da Ripat</p>

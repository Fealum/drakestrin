...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52f488549855e',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52f488549855e')) {function content_52f488549855e($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
     "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="de">
<head>
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<title>Kaiserreich Drachenstein: Hobbits</title>
...
<h3>Das Volk der Hobbits<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'createencyclopedia')>0){?> <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
...
<p>Hobbits haben eine Gr&ouml;&szlig;e von etwa 2,5-3 Ellen (ca. 1,20 m) und werden deshalb oft mit Menschenkindern verwechselt. Hobbits sind h&auml;ufig in Vincaster anzutreffen, da ihre Hauptstadt tief in einem Gebirge in Vincaster liegt und sie nur wenig Reisefreudigkeit zeigen. Sie k&ouml;nnen sich sehr gut verstecken, beherrschen jedoch kaum Magie und sind auch keine guten K&auml;mpfer. Doch wehe, man untersch&auml;tzt die Halblinge! Hinter ihrem kleinen Kopf befindet sich meist ein sehr schlaues Gehirn, mit dem sie ihren Gegner in die Knie zwingen. Doch die Hobbits sind ein friedliches Volk, das zumeist auf den Feldern arbeitet oder eine ihrer ber&uuml;hmten Pfeifen rauchen. Fr&uuml;her haben Hobbits versucht ihr Reich durch blutige Kriege auszuweiten. Der Versuch misslang und die Hobbits blieben friedlich in ihren Bergen. Nur einige wenige trauen sich heraus, doch diese haben meistens einen schwierigen Anfang mit all den neuen Rassen, die man als Hobbit nur aus Sagen und Gutenachtgeschichten kennt. </p>

		</div>
		<div id="sidebar">
			<p><a href="http://drakestrin.de/">Kaiserreich Drachenstein</a>
&raquo; <a href="http://drakestrin.de/encyclopedia">Kompendium</a> &rarr; <a href="http://drakestrin.de/encyclopedia/view/2">Allgemeines</a> &rarr; <a href="http://drakestrin.de/encyclopedia/view/4">V&ouml;lker</a> &rarr; Hobbits</p>

...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52f3c2c27e0f5',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52f3c2c27e0f5')) {function content_52f3c2c27e0f5($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
     "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="de">
<head>
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<title>Kaiserreich Drachenstein: Zeitrechnung</title>
...
<h3>Die Drakische Zeitrechnung<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'createencyclopedia')>0){?> <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
...
<p>Die drakische Zeitrechnung beruht auf einem Prinzip, das einzigartig ist: ein Jahr besitzt nur drei Monate. Diese Monate hei&szlig;en: <br />
Morikles &#150; 30 Tage (drakisch, Morikles = Anfang) <br />
Termophles &#150; 31 Tage (drakisch, Termophles = Mitte) <br />
Kaltorles &#150; 30 Tage (drakisch, Kaltorles = Schluss, Ende) <br />
&lt;p&gt;<br />
Alle acht Jahre, also immer wenn zwei Jahre in christlicher Zeitrechnung vorbei sind, wird die Uhr in Tolsa neu gestellt und feierlich auf die kommenden Jahre vorbereitet, dabei wird auch die Chronik f&uuml;r diese acht Jahre geschrieben. <br />
&lt;p&gt;<br />
Die Jahre haben jede Namen, die sich alle vier Jahre wiederholen. <br />
1tes Jahr: Kolwaik (drakisch, Kol = Kalt, Waik = Jahr, also Kaltes Jahr) <br />
2tes Jahr: Rotwaik (drakisch, Rot = Hei&szlig;, Waik = Jahr, also Hei&szlig;es Jahr) <br />
3tes Jahr: Norwaik (drakisch, Nor = Blatt, Waik = Jahr, also Blattjahr) <br />
4tes Jahr: Monwaik (drakisch, Mon =Schnee, Waik = Jahr, also Schneejahr) </p>

		</div>
		<div id="sidebar">
			<p><a href="http://drakestrin.de/">Kaiserreich Drachenstein</a>
&raquo; <a href="http://drakestrin.de/encyclopedia">Kompendium</a> &rarr; <a href="http://drakestrin.de/encyclopedia/view/2">Allgemeines</a> &rarr; Zeitrechnung</p>

...
<?php if ($_valid && !is_callable('content_52f3ff99e333b')) {function content_52f3ff99e333b($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: MacGregor</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/36.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 05.09.2003, 10:42</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; MacGregor</p>

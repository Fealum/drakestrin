...
<?php if ($_valid && !is_callable('content_52f3ee12b1ed0')) {function content_52f3ee12b1ed0($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Skarathis</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/263.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 23.01.2011, 00:27</li>
...
<h3>Betriebe</h3>
<ol>
	<li>Skarathis Laden der besonderen Sumpfg&uuml;ter: Verschiedene Waren aus der Heimat der Thisz</li>
	<li>Skarathis Alchemistenwaren: Alchemistische Waren aus dem Land der Thisz</li>
</ol>

		</div>
		<div id="sidebar">
			<p><a href="http://drakestrin.de/">Kaiserreich Drachenstein</a>
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Skarathis</p>

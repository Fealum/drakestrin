...
<?php if ($_valid && !is_callable('content_52ee0f2f0673d')) {function content_52ee0f2f0673d($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Linda van Ellerstrøm</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/295.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 03.09.2011, 21:00</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Linda van Ellerstrøm</p>

...
<?php if ($_valid && !is_callable('content_52f202f52f7f6')) {function content_52f202f52f7f6($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Piritugd</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/122.jpg" /><p id="usertext">Hallo.</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 25.06.2005, 11:59</li>
...
<h3>Besitz</h3>
<ol class="inventory">
	<li><img src="http://drakestrin.de/img/item.img/1.png" /> Dolch des Heiligen Benedikt: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/11.png" /> Pudelpulli mit rosa Bommeln: 0, 0</li>
</ol>
<h3>Betriebe</h3>
<ol>
	<li>K&ouml;nigliche Hofschmiede von Geonica: Test</li>
</ol>

		</div>
		<div id="sidebar">
			<p><a href="http://drakestrin.de/">Kaiserreich Drachenstein</a>
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Piritugd</p>

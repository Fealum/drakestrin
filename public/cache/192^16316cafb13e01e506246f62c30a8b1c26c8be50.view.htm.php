...
<?php if ($_valid && !is_callable('content_52f060b70e8f1')) {function content_52f060b70e8f1($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Casimir Schrinkelfax-Knolle</title>
...
/log">anmelden</a>]
	<?php }?>
		...
		<h2>Casimir Schrinkelfax-Knolle</h2>
		<div id="content">
...
<img src="http://drakestrin.de/img/user_avatar.id/192.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 12.11.2007, 19:51</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 1704</li>
							<li><em>Herkunft:</em> Vincaster</li>
							<li><em>Interessen:</em> Reisen, Basteln</li>
							<li><em>Amt oder Beruf:</em> Mechanicus</li>
				</ol>
	</li>
...
" class="option create" title="neue Kontaktm&ouml;glichkeit hinzuf&uuml;gen">neue Kontaktm&ouml;glichkeit hinzuf&uuml;gen</a><?php }?></h4>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Casimir Schrinkelfax-Knolle</p>

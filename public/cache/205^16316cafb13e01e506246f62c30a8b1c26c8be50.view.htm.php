...
<?php if ($_valid && !is_callable('content_52f38107beb44')) {function content_52f38107beb44($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Eilonwy</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/205.jpg" /><p id="usertext">Wer den Feind umarmt, macht ihn bewegungsunf&auml;hig.<br />
_Unbekannt</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 11.06.2008, 14:58</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> weiblich</li>
							...
							<li><em>Interessen:</em> Das Wohl ihrer Mitmenschen und die Liebe zu Manys Taklon</li>
							<li><em>Amt oder Beruf:</em> K&ouml;nigin von Vincaster und Reichsbibliothekarin</li>
				</ol>
	</li>
</ol>
...
<ol class="inventory">
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Eilonwy</p>

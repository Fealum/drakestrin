...
<?php if ($_valid && !is_callable('content_52f3c311841e9')) {function content_52f3c311841e9($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Baudouin de Gastinois</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/143.jpg" /><p id="usertext">K&ouml;nig von Pelata, Reichskanzler und Reichsassessor des &Auml;usseren (oder so ;) )</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 04.12.2005, 18:59</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 1988</li>
							<li><em>Herkunft:</em> Pelata</li>
								</ol>
	</li>
...
" class="option create" title="neue Kontaktm&ouml;glichkeit hinzuf&uuml;gen">neue Kontaktm&ouml;glichkeit hinzuf&uuml;gen</a><?php }?></h4>
				<ol>
				<li><em>ICQ:</em> <a href="http://www.icq.com/people/313810439/">313810439</a><?php if (($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'edituser')==2||($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'edituser')==1&&$_smarty_tpl->tpl_vars['user']->value->id==$_smarty_tpl->tpl_vars['obj']->value->id))){?> <a href="http://drakestrin.de/user/editcontact/43" class="option edit" title="Kontaktm&ouml;glichkeit bearbeiten">Kontaktm&ouml;glichkeit bearbeiten</a> <a href="http://drakestrin.de/user/deletecontact/43" class="option delete" title="Kontaktm&ouml;glichkeit l&ouml;schen">Kontaktm&ouml;glichkeit l&ouml;schen</a><?php }?></li>
			</ol>
			</li>
</ol>
...
<h3>Besitz</h3>
<ol class="inventory">
	<li><img src="http://drakestrin.de/img/item.img/42.png" /> Wein  &raquo;Grand Blois&laquo;: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/44.png" /> Wein &raquo;Bretagnol&laquo;: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/43.png" /> Wein  &raquo;Grand Blois Auslese&laquo;: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/45.png" /> Wein &raquo;Vin D&#146;Annecy&laquo;: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/45.png" /> Wein &raquo;Vin D&#146;Annecy&laquo;: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/41.png" /> Wein  &raquo;Perpignan&laquo;: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/71.png" /> Kaninchen: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/80.png" /> Milchkuh: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/179.png" /> Labrador: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/181.png" /> Sch&auml;ferhund: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/182.png" /> Sch&auml;ferhund-Labrador: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/77.png" /> Wildschweinkeiler: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/73.png" /> Westtibetanisches Wollmeerschwein: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/64.png" /> Vierklee-Honig: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/64.png" /> Vierklee-Honig: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/66.png" /> Vierklee-Met: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/67.png" /> Dicke Bienenwachskerze: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/67.png" /> Dicke Bienenwachskerze: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/64.png" /> Vierklee-Honig: 0, 0</li>
	...
	<li><img src="http://drakestrin.de/img/item.img/90.png" /> Honigkekse: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/84.png" /> K&auml;selaib: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/84.png" /> K&auml;selaib: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/84.png" /> K&auml;selaib: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/84.png" /> K&auml;selaib: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/84.png" /> K&auml;selaib: 0, 0</li>
	...
	<li><img src="http://drakestrin.de/img/item.img/84.png" /> K&auml;selaib: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/64.png" /> Vierklee-Honig: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/69.png" /> Schwarzbrot: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/90.png" /> Honigkekse: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/43.png" /> Wein  &raquo;Grand Blois Auslese&laquo;: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/43.png" /> Wein  &raquo;Grand Blois Auslese&laquo;: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/42.png" /> Wein  &raquo;Grand Blois&laquo;: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/42.png" /> Wein  &raquo;Grand Blois&laquo;: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/42.png" /> Wein  &raquo;Grand Blois&laquo;: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/40.png" /> Wein  &raquo;Grand Vend&ocirc;me&laquo;: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/40.png" /> Wein  &raquo;Grand Vend&ocirc;me&laquo;: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/40.png" /> Wein  &raquo;Grand Vend&ocirc;me&laquo;: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/40.png" /> Wein  &raquo;Grand Vend&ocirc;me&laquo;: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/66.png" /> Vierklee-Met: 0, 0</li>
...
<h3>Betriebe</h3>
<ol>
	<li>Domaine viticole Gastinois: Weinkelterei mit langer Tradition</li>
	<li>Animaux Gastinois: Vom fliegenden Pferd bis zum gr&ouml;&szlig;ten Gaumenschmaus, hier gibt es jedes Tier</li>
	<li>Habbilages de Dames et de Messieurs Gastinois: Gesch&auml;ft f&uuml;r feine Damen-  und Herrenbekleidung</li>
	<li>Boulangerie Gastinois: Feinstes Backwerk und andere k&ouml;stlichkeiten</li>
</ol>

		</div>
		<div id="sidebar">
			<p><a href="http://drakestrin.de/">Kaiserreich Drachenstein</a>
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Baudouin de Gastinois</p>

...
<?php if ($_valid && !is_callable('content_52f3700716188')) {function content_52f3700716188($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Melima</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/172.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 19.02.2007, 22:43</li>
...
<h3>Betriebe</h3>
<ol>
	<li>Melimas Praxis: Hier in Melimas Praxis finden sie Hilfe bei Seelischen und geistigen Problemen.Wir bieten Meditationsstunden f&uuml;r Dauergestresste, Phobientherapien und helfen ihnen bei Problemen mit ihrem zweiten Ich . </li>
</ol>

		</div>
		<div id="sidebar">
			<p><a href="http://drakestrin.de/">Kaiserreich Drachenstein</a>
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Melima</p>

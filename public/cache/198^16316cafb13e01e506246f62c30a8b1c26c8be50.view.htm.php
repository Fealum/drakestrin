...
<?php if ($_valid && !is_callable('content_52edfb06aaaab')) {function content_52edfb06aaaab($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Gerhardt Hockmann</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/198.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 10.03.2008, 19:25</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							...
							<li><em>Herkunft:</em> Norduryyk</li>
									<li><em>Amt oder Beruf:</em> Diplomat</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Gerhardt Hockmann</p>

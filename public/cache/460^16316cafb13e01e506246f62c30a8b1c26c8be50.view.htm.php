...
<?php if ($_valid && !is_callable('content_52ed5ddcac9b0')) {function content_52ed5ddcac9b0($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';

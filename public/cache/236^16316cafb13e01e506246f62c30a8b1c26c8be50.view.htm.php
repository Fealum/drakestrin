...
<?php if ($_valid && !is_callable('content_52ee359c0dd66')) {function content_52ee359c0dd66($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Tadeus</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/236.jpg" /><p id="usertext">Mit treuem Gru&szlig;e, Tadeus </p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 18.12.2009, 23:06</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 685</li>
											<li><em>Amt oder Beruf:</em> Soldat</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Tadeus</p>

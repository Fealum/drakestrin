...
<?php if ($_valid && !is_callable('content_52f2902b8fee3')) {function content_52f2902b8fee3($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Xerxes IX.</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/184.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 27.04.2007, 19:27</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 273</li>
							<li><em>Herkunft:</em> Stadt Bloodmourne</li>
							<li><em>Interessen:</em> Regieren, die Magie, Drachen, Kunst, Wissen</li>
							<li><em>Amt oder Beruf:</em> Kaiser von Bloodmourne-Veldrion</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Xerxes IX.</p>

...
<?php if ($_valid && !is_callable('content_52f2fca15594a')) {function content_52f2fca15594a($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Arthur von Hochwald</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/84.jpg" /><p id="usertext">Nur weiter, nur weiter! <br />
---<br />
ZweitID von Veuxin</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 24.06.2004, 17:01</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 1952</li>
							<li><em>Herkunft:</em> Northshire / Pretanz</li>
									<li><em>Amt oder Beruf:</em> Hofmarschall des Schlosses Pretannica</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Arthur von Hochwald</p>

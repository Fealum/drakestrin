...
<?php if ($_valid && !is_callable('content_52f379af5dc6f')) {function content_52f379af5dc6f($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Willi Brandt</title>
...
<ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 07.04.2005, 14:10</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Willi Brandt</p>

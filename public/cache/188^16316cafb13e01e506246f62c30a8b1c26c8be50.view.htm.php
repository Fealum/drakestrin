...
<?php if ($_valid && !is_callable('content_52f4926203b16')) {function content_52f4926203b16($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Pete Parker</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/188.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 17.05.2007, 18:46</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
									<li><em>Herkunft:</em> Aquatropolis</li>
									<li><em>Amt oder Beruf:</em> Pers&ouml;hnlicher Sekret&auml;r des Gro&szlig;neptun</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Pete Parker</p>

...
<?php if ($_valid && !is_callable('content_52f3cf46bb79e')) {function content_52f3cf46bb79e($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Rhogan</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/210.jpg" /><p id="usertext">Schamane</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 05.07.2008, 13:56</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
									<li><em>Herkunft:</em> Terra Barbarica</li>
									<li><em>Amt oder Beruf:</em> H&auml;uptling</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Rhogan</p>

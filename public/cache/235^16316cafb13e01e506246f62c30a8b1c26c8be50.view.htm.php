...
<?php if ($_valid && !is_callable('content_52e82bd036bb9')) {function content_52e82bd036bb9($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Marcus Flavius Celtillus</title>
...
/log">anmelden</a>]
	<?php }?>
		...
		<h2>Marcus Flavius Celtillus</h2>
		<div id="content">
...
<img src="http://drakestrin.de/img/user_avatar.id/235.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 16.12.2009, 15:09</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 2721</li>
							<li><em>Herkunft:</em> Eph&egrave;be</li>
									<li><em>Amt oder Beruf:</em> Kaiser</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Marcus Flavius Celtillus</p>

...
<?php if ($_valid && !is_callable('content_52f4d18fa5130')) {function content_52f4d18fa5130($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Erinn</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/78.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 23.03.2004, 10:36</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> weiblich</li>
									<li><em>Herkunft:</em> wohin der Wind mich treibt</li>
								</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Erinn</p>

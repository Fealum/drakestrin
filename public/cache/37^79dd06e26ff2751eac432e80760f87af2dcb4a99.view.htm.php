...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52f3b37b57681',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52f3b37b57681')) {function content_52f3b37b57681($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
     "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="de">
<head>
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<title>Kaiserreich Drachenstein: Flagge</title>
...
<h3>Die Flagge Drachensteins<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'createencyclopedia')>0){?> <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
...
<p>Diese Flagge wurde 2005 entworfen, als das Kaiserreich Esturien-Drachenstein gegr&uuml;ndet wurde und dann vom Kaiserreich Drachenstein als Nachfolger &uuml;bernommen worden. Sie ist damit ziemlich neu, &uuml;bernimmt aber viele Elemente alter Flaggen, etwa des Banners des ersten Kaiserreiches, der davon abgewandelten Flagge der Runischen Kirche (Hier sieht man schon das Tyberio-Kreuz, welches sp&auml;ter in der aktuellen Flagge auftauchen wird), das Wappen von Drachenstein oder das Kreuz von Esturien. Andere Flaggen wurden dann von dieser Flagge abgeleitet: So etwa die Farbenlehrflagge des drakischen Gelehrten Wincente Morilias, der damit den Einfluss diverser Faktoren auf die Farbdarstellung demonstrieren will oder die Sonnenflagge eines runischen Klosters in Pelata. &lt;p&gt;<br />
<br />
Die Gestaltung der Flagge nimmt Verbindung zum Banner des ersten Kaiserreiches auf und verweist damit auf die lange Geschichte Drachensteins. Das dort enthaltene Tyberio-Kreuz, auf der Flagge in wei&szlig; (Reinheit, Licht) gehalten, ist seit jeher ein wichtiges Symbol im Runischen Glauben, auch ist dies das Kreuz, unter welchem die Drachensteiner seit jeher in den Krieg ziehen. Das zentrale rote Kreuz jedoch ist der Esturischen Flagge entliehen und zeigt so die Verbundenheit Esturiens mit dem &uuml;brigen Kaiserreich, nachdem die Provinz aufgenommen wurde. Um jedoch die weiter Vorherrschaft des Kaiserreiches anzuzeigen, sitzt dar&uuml;ber in einem gr&uuml;nen (Hoffnung und Ordnung) Kreis (Vollkommenheit) der rote Drache Xer, das Wappentier Drachensteins. &lt;p&gt;<br />
<br />
&lt;center&gt;&lt;img src=&raquo;http://www.drakestrin.de/mnwiki/flagge-drachenstein-mnwiki.gif&laquo;&gt;&lt;/center&gt;&lt;p&gt;<br />
<br />
Die heraldische Darstellung der Flagge lautet folgenderma&szlig;en: &raquo;Eine wei&szlig;e (argent) Fahne misst eine H&ouml;he Zwei und eine Breite Drei. Darauf ein rotes (sanguine) zentriertes Kreuz mit der Balkenbreite eines Sechstels der Fahnenh&ouml;he. Auf dem Kreuz in der Mitte der Fahne ein gr&uuml;ner (vert) Kreis, dessen Radius ein Viertel der Fahnenh&ouml;he betr&auml;gt. Darin ein steigender (salient a sinister) roter (sanguine) Drache. Auf den vier wei&szlig;en (argent) Fl&auml;chen jeweils: Zwei gr&uuml;ne (vert), rechtwinklige Dreiecke, das Erste davon zentriert in der wei&szlig;en Fl&auml;che mit der l&auml;ngeren Kathetenseite auf der Fahnenl&auml;nge liegend, wobei diese Seite ein Drittel der Fahnenl&auml;nge lang ist. Die kurze Kathetenseite auf der Seite der Mittelsenkrechten der Fahnenl&auml;nge und mit dieser im Lot, halb so lang wie die lange Kathetenseite. Beide freien Kathetenpunkte miteinander verbunden f&uuml;r die Hypothenuse. F&uuml;r das zweite Dreieck nimmt man das erste Dreieck, spiegelt es horizontal und vertikal und setzt dann die kurze Kathetenseite in die Mitte der H&auml;lfte der breiten Fahnenseite, mit der Kathetenseite an der Fahnenseite anliegend.&laquo;</p>

		</div>
		<div id="sidebar">
			<p><a href="http://drakestrin.de/">Kaiserreich Drachenstein</a>
&raquo; <a href="http://drakestrin.de/encyclopedia">Kompendium</a> &rarr; <a href="http://drakestrin.de/encyclopedia/view/2">Allgemeines</a> &rarr; <a href="http://drakestrin.de/encyclopedia/view/35">Nationale Symbole</a> &rarr; Flagge</p>

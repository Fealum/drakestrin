...
<?php if ($_valid && !is_callable('content_52f4422518cac')) {function content_52f4422518cac($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Prinz Xizor</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/158.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 08.10.2006, 18:37</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 1993</li>
							<li><em>Herkunft:</em> Pelata</li>
							<li><em>Interessen:</em> Fu&szlig;ball, Tennis, Volleyball</li>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Prinz Xizor</p>

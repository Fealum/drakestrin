...
<?php if ($_valid && !is_callable('content_52f348be7085c')) {function content_52f348be7085c($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Martin Aientdorae</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/471.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 10.06.2013, 13:12</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
									<li><em>Herkunft:</em>  Felseninsel</li>
							<li><em>Interessen:</em>  Tiere besch&uuml;tzen</li>
							<li><em>Amt oder Beruf:</em> Schafhirte</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Martin Aientdorae</p>

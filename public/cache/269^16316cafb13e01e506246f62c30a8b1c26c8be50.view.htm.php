...
<?php if ($_valid && !is_callable('content_52da3a104b383')) {function content_52da3a104b383($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Prof. Wilhelm von Graubünden</title>
...
/log">anmelden</a>]
	<?php }?>
		...
		<h2>Prof. Wilhelm von Graubünden</h2>
		<div id="content">
...
<img src="http://drakestrin.de/img/user_avatar.id/269.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 16.05.2011, 17:03</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Prof. Wilhelm von Graubünden</p>

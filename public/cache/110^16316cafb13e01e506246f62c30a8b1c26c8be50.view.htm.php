...
<?php if ($_valid && !is_callable('content_52f3ce95568c5')) {function content_52f3ce95568c5($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Lero von Springinsfeld</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/110.jpg" /><p id="usertext">Lero von Springinsfeld:<br />
Reiten (Fortgeschritten)<br />
Schwertkampf (Anf&auml;nger)<br />
&quot;Ich bin ein Ritter auf der suche nach einer Holden Maid&quot;</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 02.01.2005, 11:05</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
									<li><em>Herkunft:</em> Weit, weit weg.</li>
							<li><em>Interessen:</em> Reitn, K&auml;mpfen, Poseidon (mein Pferd)</li>
							<li><em>Amt oder Beruf:</em> Ritter</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Lero von Springinsfeld</p>

...
<?php if ($_valid && !is_callable('content_52ef0bc88ed67')) {function content_52ef0bc88ed67($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Grifften von Hagen</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/13.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 05.07.2003, 14:33</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
									<li><em>Herkunft:</em> Pelata/Drachenstein</li>
								</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Grifften von Hagen</p>

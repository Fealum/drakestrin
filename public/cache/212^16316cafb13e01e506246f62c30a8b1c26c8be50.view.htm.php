...
<?php if ($_valid && !is_callable('content_52f47154618c2')) {function content_52f47154618c2($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Elisabeth</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/212.jpg" /><p id="usertext">-&gt;Death is a shadow that always follows  the body!</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 04.09.2008, 17:25</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> weiblich</li>
							<li><em>Geburtstag:</em> 1902</li>
							<li><em>Herkunft:</em> Vincaster</li>
							<li><em>Interessen:</em> Beobachten, jagen und den Mond ansehen</li>
							<li><em>Amt oder Beruf:</em> J&auml;gerin, Spion</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Elisabeth</p>

...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52f3abee7a936',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52f3abee7a936')) {function content_52f3abee7a936($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
     "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="de">
<head>
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<title>Kaiserreich Drachenstein: Orkkrieg</title>
...
<h3>Die Erz&auml;hlung vom Orkkrieg<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'createencyclopedia')>0){?> <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
...
<p><i>Wir schreiben das Jahr 35623 n.d.Z. und Ihr seid in einem verkommenen Gasthaus in der Wildnis von Pelata. Und Euch wird erz&auml;hlt. Von den Leiden und Schrecken, die der Orkkrieg &uuml;ber das Land brachte. Von einem nun alten Feuergreiffen, der diese Leiden und Schrecken als junger Recke erlebte.</i><br />
<br />
Die Orks kamen in Scharen. &Uuml;ber Milliarden Mann m&uuml;ssen es gewesen sein, gro&szlig;e und kleine, bestens ausger&uuml;stete und nur mit einer Keule bewaffneten. Sie alle standen im Dienst des Schrecklichen. Nein, den Namen will ich an dieser Stelle nicht nennen, zu viele schlechte Erinnerungen verbinde ich mit ihm. Sie kamen in Scharen. Sie kamen in Scharen von Hunderten. Sie kamen in Scharen von Tausenden. Sie kamen &uuml;ber H&uuml;gel, &uuml;ber W&auml;lder, &uuml;ber Fl&uuml;sse. Sie t&ouml;teten. Alles. Meine Frau, meine Kinder, meine Eltern. Ich war an die 25 Jahre alt. Und ich sah das Grauen, das sich in den Augen meiner toten, gesch&auml;ndeten Frau spiegelte. Nie werde ich diesen Gesichtsausdruck vergessen k&ouml;nnen. Nie werde ich &hellip; vergessen k&ouml;nnen.<br />
<br />
Die Orks waren m&auml;chtig und schon bald hatten sie Pisar unter Kontrolle. Ja, mein Sohn, gro&szlig;e Teile dieses wunderbaren und riesigen Landes der Drachen und Elben! Viele mussten ihr Leben lassen. Denn es herrschte Krieg.<br />
<br />
Dann kam ein neuer, m&auml;chtiger Kriegsherr: Faantir der M&ouml;rder. Und er t&ouml;tete den Schrecklichen. Viele fanden unter ihm den Tod. Und die Orks nahmen sich Vincaster. Ja, sie marschierten ein mit ihren Keulen und &Auml;xten, vergifteten die Felder und vergewaltigten die M&auml;gde, verbrannten die W&auml;lder und verseuchten die Gew&auml;sser. Die tapferen Hobbits und Zwerge, Elfen und Feen, das gesamte kleine Volk, sie fielen wie reifes Heu vor der Sense. Die Erde war durchtr&auml;nkt von Blut und auf den Schlachtfeldern wuchsen nur noch die Pflanzen der Orks, gef&auml;hrliche Schlingpflanzen und fleischfressende Kriechpflanzen.<br />
<br />
Die V&ouml;lker des S&uuml;dens verb&uuml;ndeten sich. Nur so war eine Rettung m&ouml;glich. Und unter Veuxin II. , Kaiser von Drachenstein, wurden sie zur&uuml;ckgedr&auml;ngt bis auf die Insel Walz. Doch dort bauten sie eine Festung, gr&ouml;&szlig;er und m&auml;chtiger als ein lebendes Wesen es sich vorstellen kann. Und schrecklicher. Noch am anderen Ufer h&ouml;rten die wenigen Bauern, die versuchten, auf der verbrannten Erde etwas anzubauen, die Todesschreie der Gefolterten, markersch&uuml;tternde, d&uuml;nne, hohe Stimmen, gepaart mit den mechanischen Schl&auml;gen der Kriegsschmieden. &Uuml;ber der Insel Walz hing ein Nebel aus rotem Dampf, aufgestiegen aus den Tiefen, die die Orks gegraben hatten. Tiefe Gr&auml;ben, die in die Feuer der Erde ragten.<br />
<br />
Doch dann starb Faantir der M&ouml;rder. Durch einen Himmelsgreiffen konnte er wieder zu seiner friedlichen, ehemaligen Existenz zur&uuml;ckgeraten. Seine Seele jedoch ging &uuml;ber in die Leiche des Schrecklichen und dieser erstand neu auf. Neue Leiden kamen &uuml;ber das Land. Doch die Xataxer kamen zur Hilfe und retteten Drachenstein vor der Schreckensherrschaft.<br />
<br />
Gemeinsam konnten die Orks weit zur&uuml;ckgedr&auml;ngt werden in den Norden des Planeten Pegasus. Und der Schreckliche konnte get&ouml;tet werden. Doch noch heute &uuml;berfallen die verschiedenen Orkst&auml;mme H&auml;ndler und andere Reise und richten sie gar furchtbar zu. Die Gefahr wurde nie gebannt.<br />
<br />
Hoffen wir&hellip;auf&hellip;neue&hellip;Zeiten un&hellip;und neue&hellip;Leg&hellip;Legenden&hellip;bessere&hellip;<br />
<br />
<i>Der Mann kippt langsam vorn&uuml;ber auf den Tisch. Zuerst denkt Ihr, er schl&auml;ft. Doch als Ihr ihn aufwecken wollt, bemerkt Ihr die K&auml;lte seines K&ouml;rpers. Das letzte Opfer des Orkkriegs hat soeben das Tor zum ewigen Dunkel in Zerrons unerm&uuml;dlichem Reich des Friedens durchschritten.<br />
Zum Gl&uuml;ck kennt Ihr die Geschichte und k&ouml;nnt diese weiterverbreiten. So gibt es nicht eine weitere Sage, die in Vergessenheit ger&auml;t und die nie wieder erz&auml;hlt wird.</i></p>

		</div>
		<div id="sidebar">
			<p><a href="http://drakestrin.de/">Kaiserreich Drachenstein</a>
&raquo; <a href="http://drakestrin.de/encyclopedia">Kompendium</a> &rarr; <a href="http://drakestrin.de/encyclopedia/view/7">Kultur</a> &rarr; <a href="http://drakestrin.de/encyclopedia/view/8">Sagen &amp; Legenden</a> &rarr; Orkkrieg</p>

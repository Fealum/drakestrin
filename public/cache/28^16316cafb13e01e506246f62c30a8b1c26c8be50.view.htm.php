...
<?php if ($_valid && !is_callable('content_52f314a92e1a3')) {function content_52f314a92e1a3($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Tobias der Eroberer</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/28.jpg" /><p id="usertext">Atan vuzzis drakestrin.</p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 08.08.2003, 16:57</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
									<li><em>Herkunft:</em> Vincaster, Vintor</li>
								</ol>
	</li>
</ol>
...
<h3>Besitz</h3>
<ol class="inventory">
	<li><img src="http://drakestrin.de/img/item.img/6.png" /> Schwert des Eroberers: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/7.png" /> Einfaches Hemd: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/9.png" /> Einfache Hose: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/10.png" /> Einfacher Stiefel (rechts): 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/10.png" /> Einfacher Stiefel (links): 0, 0</li>
	...
	<li><img src="http://drakestrin.de/img/item.img/51.png" /> Normaler Kurzbogen: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/57.png" /> Stabiler Kurzbogen: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/56.png" /> Normaler Langbogen: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/58.png" /> Stabiler Langbogen: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/59.png" /> Elbenbogen: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/60.png" /> Elbenk&ouml;nigsbogen: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/47.png" /> Normaler Pfeil: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/48.png" /> Besserer Pfeil: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/49.png" /> Genauer Pfeil: 0, 0</li>
	<li><img src="http://drakestrin.de/img/item.img/50.png" /> T&ouml;dlicher Pfeil: 0, 0</li>
	...
	<li><img src="http://drakestrin.de/img/item.img/74.png" /> Orden des Ahornblatts: 0, 0</li>
	...
	<li><img src="http://drakestrin.de/img/item.img/91.png" /> Bienengift: 0, 0</li>
</ol>
<h3>Betriebe</h3>
<ol>
	<li>Drachenstein Waren: Waren aller Art: Nahrung - Kleidung - Waffen - Magiebedarf - Unikate</li>
	<li>Drachenstein Quellen: Drachenstein Quellen baut direkt die Ressourcen in gro&szlig;en Mengen ab und verkauft sie an Gro&szlig;h&auml;ndler weiter</li>
</ol>

		</div>
		<div id="sidebar">
			<p><a href="http://drakestrin.de/">Kaiserreich Drachenstein</a>
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Tobias der Eroberer</p>

...
<?php if ($_valid && !is_callable('content_52ed688c949d1')) {function content_52ed688c949d1($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Lady Elena</title>
...
<ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 17.11.2004, 20:33</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> weiblich</li>
							...
							<li><em>Herkunft:</em> aus den fernen s&uuml;dlanden</li>
							<li><em>Interessen:</em> reiten, freunde treffen, telefonieren,..........</li>
							<li><em>Amt oder Beruf:</em> sch&uuml;lerin</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Lady Elena</p>

...
<?php if ($_valid && !is_callable('content_52f27c00aec43')) {function content_52f27c00aec43($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Banhan-sot</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/244.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 09.06.2010, 01:26</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
									<li><em>Herkunft:</em> Dehonnahihi</li>
									<li><em>Amt oder Beruf:</em> Hammahuroreh</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Banhan-sot</p>

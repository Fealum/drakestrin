...
<?php if ($_valid && !is_callable('content_52f33d120249e')) {function content_52f33d120249e($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Tlaloc</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/77.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 20.03.2004, 11:08</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 1</li>
							<li><em>Herkunft:</em> Leere</li>
							<li><em>Interessen:</em> Ethik, Ethnologie, Terminologie</li>
							<li><em>Amt oder Beruf:</em> Moralist</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Tlaloc</p>

...
<?php if ($_valid && !is_callable('content_52ec5e81cd8c1')) {function content_52ec5e81cd8c1($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Sidd</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/470.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 20.05.2013, 21:00</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
									<li><em>Herkunft:</em> Freie Republik T&iacute;r na n&Ograve;g</li>
							<li><em>Interessen:</em> Uisge Beatha</li>
							<li><em>Amt oder Beruf:</em> Gro&szlig;rat</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Sidd</p>

...
<?php if ($_valid && !is_callable('content_52f35acc76f37')) {function content_52f35acc76f37($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Faantir Gried</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/68.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 10.01.2004, 17:22</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> m&auml;nnlich</li>
							<li><em>Geburtstag:</em> 1983</li>
							<li><em>Herkunft:</em> Futuna</li>
									<li><em>Amt oder Beruf:</em> Wesir f&uuml;r &Auml;u&szlig;eres</li>
				</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Faantir Gried</p>

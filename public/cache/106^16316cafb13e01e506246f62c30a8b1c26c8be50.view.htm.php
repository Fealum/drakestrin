...
<?php if ($_valid && !is_callable('content_52d37994d7d42')) {function content_52d37994d7d42($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Bestrafter (gesperrt)</title>
...
<p id="usertext">Ich habe gegen geltendes Recht verbrochen und wurde deswegen verbannt! Ich nehme alle Beleidigungen zur&uuml;ck! </p><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 09.12.2004, 13:59</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Bestrafter (gesperrt)</p>

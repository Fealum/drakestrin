...
<?php if ($_valid && !is_callable('content_52ed8df107af7')) {function content_52ed8df107af7($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Zerron</title>
...
<ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 15.11.2005, 21:05</li>
...
<ol class="inventory">
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Zerron</p>

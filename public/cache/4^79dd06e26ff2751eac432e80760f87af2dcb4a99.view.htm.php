...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52ea02f562831',
  'has_nocache_code' => true,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52ea02f562831')) {function content_52ea02f562831($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_date_format')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.date_format.php';
?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"
     "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="de">
<head>
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<title>Kaiserreich Drachenstein: V&ouml;lker</title>
...
<h3>Die V&ouml;lker Drachensteins<?php if ($_smarty_tpl->tpl_vars['permission']->value->getPermission($_smarty_tpl->tpl_vars['obj']->value,'createencyclopedia')>0){?> <a href="<?php echo $_smarty_tpl->tpl_vars['config']->value->url;?>
...
<p>In Drachenstein herrschen sieben gro&szlig;e V&ouml;lker vor, welche sich in Gestalt wie auch in Kultur sehr unterscheiden. Obwohl es Anliegen der Regierung im Sinne eines stabilen und vereinigten Reiches ist, die V&ouml;lker gleich zu behandeln und gedankliche Schranken abzubauen, ist, begr&uuml;ndet auf eine lange und blutige Tradition, Rassismus immer noch stets an der Tagesordnung und pr&auml;gt das einfache Leben ganz gewaltig. <br />
<br />
&Uuml;ber ein F&uuml;nftel der Gesamtbev&ouml;lkerung (21 Prozent) stellen die <strong>Menschen</strong>. Die Geschichte der Menschen in Drachenstein ist vergleichsweise kurz, sie begann erst vor etwa 6000 Jahren, als mit Martinus I., dem ersten Kaiser und R&ouml;mer von Geburt an, ein Handelsschiff an der K&uuml;ste der Insel Pretanz anstrandete. Dennoch haben es die Menschen geschafft, durch geschickte B&uuml;ndnispolitik und wenig w&auml;hlerischem Heiratsverhalten die gr&ouml;&szlig;te Bev&ouml;lkerungsgruppe Drachensteins zu stellen und abgesehen von den Vampiren politisch die wichtigste Rolle zu &uuml;bernehmen, eine Tatsache, die sich im stark menschlich gepr&auml;gten Alltag eindeutig herauskristallisiert. <br />
<br />
Ihnen folgen mit 17 Prozent die <strong>Hobbits</strong>, die schon immer zusammen mit den Elfen die Vincastrische H&uuml;gellandschaft bewohnten und somit als eines der eingesessensten V&ouml;lker Drachensteins gelten d&uuml;rfen. Die Hobbits sehen es als Tradition, sich nicht in die Angelegenheiten anderer einzumischen, und sind deswegen abgesehen vom stark hobbitgepr&auml;gten Vincaster in Drachenstein nur wenig vertreten, k&ouml;nnen aber, sollte ihnen Unrecht geschehen, durchaus kriegerische Z&uuml;ge aufweisen. <br />
<br />
Die <strong>Vampire</strong> stellen 15 Prozent der Bev&ouml;lkerung, erscheinen aber als wichtigste Gruppe, da sie als Einzelg&auml;nger dazu neigen, sich &uuml;ber das ganze Land zu verbreiten und sich gerne in wichtigen Positionen sehen, von wo aus sie in der Lage sind, zum Wohl oder auch zum Unwohl anderer zu entscheiden. So ist auch beispielsweise die Kaiserfamilie ein Spross dieses Volkes &ndash;&nbsp;wen verwundert es da, dass kaum ein b&ouml;ses Wort in der &Ouml;ffentlichkeit gegen die Vampire erhoben wird, obwohl man ihnen mancherlei unangenehme Eigenschaften nachsagt? <br />
<br />
Wie die Hobbits haupts&auml;chlich in Vincaster, aber auch in Pelata kommen die <strong>Elfen</strong> vor, denen 14 Prozent der Bev&ouml;lkerung angeh&ouml;ren. Auch sie neigen dazu, sich nur wenig in die Angelegenheiten anderer einzumischen, k&ouml;nnen aber die reinste Lynchjustiz veranstalten, verst&ouml;&szlig;t man in ihrem Geltungsbereich gegen ihre recht strengen Regeln &ndash;&nbsp;ein Grund, der sicherlich zum eher schadhaften Bild dieses ansonsten sehr naturliebenden Volkes beigetragen hat. <br />
<br />
<strong>Elben</strong> bestreiten dank ihren langen Alters heute wieder einen Bev&ouml;lkerungsanteil von 12 Prozent, obwohl sie in der Vergangenheit manch blutigem Zwischenfall zum Opfer fielen, nachdem sie sich mit der Machtgier der sich ausbreitenden Menschen nach Malazien auseinandergesetzt hatten. Diese Ereignisse st&ouml;ren immer noch sehr das Verh&auml;ltnis zwischen Elben und Menschen, obwohl erste Schritt in die gegenteilige Richtung unternommen werden. <br />
<br />
Weitere 9 Prozent, jedoch nahezu komplett auf die Berge in Pisar und Vincaster komprimiert, stellen die <strong>Zwerge</strong>, die sich durch ihr kriegerisches Wesen und ihre stets wichtige Rolle im kriegsentscheidenden Bergbau eine gewisse Sonderrolle erspielt haben. Obwohl sie allgemein geachtet werden, da sich ihre Herrschaftsanspr&uuml;che unterirdisch beschr&auml;nken, munkelt man einiges &uuml;ber die anscheinend dunklen Geheimnisse, die in den tiefen Stollen gehortet werden sollen. <br />
<br />
Nur 3 Prozent der Bev&ouml;lkerung machen die <strong>Drachen</strong> aus, obwohl ihr majest&auml;tisches Erscheinen, einige furchterregende Volkssagen und die riesigen Landstreifen Westpisars, die sie in Anspruch nehmen, sicher daf&uuml;r sorgen, dass sie um Einiges m&auml;chtiger erscheinen. Drachen agieren oft umsichtig, k&ouml;nnen jedoch auch sehr brutal richten und scheuen nicht davor, Gegner einfach zu vernichten. &Uuml;ber die Anerkennung der Drachen als eigenes Volk wird gerne geschimpft, verst&auml;ndlicherweise umso mehr, je man sich von ihrem Herrschaftsgebiet entfernt. <br />
<br />
Neun Prozent der Bev&ouml;lkerung setzen sich aus <strong>anderen V&ouml;lkern</strong> zusammen, die aus fremden L&auml;ndern nach Drachenstein gekommen sind oder nur von kleiner Zahl sind, so etwa Leoniden, Minotauren, Greiffen oder Einh&ouml;rner. Je nach Landstrich k&ouml;nnen die Meinungen &uuml;ber diese Exoten von freundlich-neutral bis aufrichtig b&ouml;se tendieren, weswegen sie gerne unter sich bleiben. </p>
<h3>Unterseiten</h3>
<ol>
...
&raquo; <a href="http://drakestrin.de/encyclopedia">Kompendium</a> &rarr; <a href="http://drakestrin.de/encyclopedia/view/2">Allgemeines</a> &rarr; V&ouml;lker</p>

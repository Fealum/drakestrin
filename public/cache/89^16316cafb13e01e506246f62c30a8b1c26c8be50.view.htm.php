...
<?php if ($_valid && !is_callable('content_52f4004c2b91d')) {function content_52f4004c2b91d($_smarty_tpl) {?><?php $_smarty = $_smarty_tpl->smarty; if (!is_callable('smarty_modifier_replace')) include '/var/www/l3s658/html/drakestrin/library/ext/smarty/libs/plugins/modifier.replace.php';
...
<title>Kaiserreich Drachenstein: Yolanda Reba</title>
...
<img src="http://drakestrin.de/img/user_avatar.id/89.jpg" /><ol class="columns">
	<li><h4>Aktivit&auml;t</h4>
		<ol>
			<li><em>Mitglied seit:</em> 24.10.2004, 21:56</li>
...
" class="option edit" title="editieren">editieren</a><?php }?></h4>
		<ol>
					<li><em>Geschlecht:</em> weiblich</li>
							...
							<li><em>Interessen:</em> Reiten, Fechten, Bogenschie&szlig;en, Kunst und Kultur</li>
						</ol>
	</li>
</ol>
 ...
 &raquo; <a href="http://drakestrin.de/user">Mitglieder</a> &rarr; Yolanda Reba</p>

<x-main-layout title="Konversationen" css="conversation">
    <ol id="conversations">
        ...
        <li>
            <h4>
                @if ($conversation['latest_message']->user__recipient == auth()->user()->id && $conversation['latest_message']->view === 0)
                [ungelesen]
                @endif
                ...
                <x-datetime :time="$conversation['latest_message']->time" />
            ...
            <p>
                ...
                @php
                    ...
                    if (!mb_check_encoding($conversation['latest_message']->message, 'ISO-8859-1')) {
                        // $message = $conversation['latest_message']->message;
                    }
